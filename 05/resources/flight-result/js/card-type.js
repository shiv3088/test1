...
/***/ (function(module, exports, __webpack_require__) {
	...
	setCardType = function(e) {
	  ...
	  if(cardType == 'visa'){
		  ...
		  cardTypeTemp = 'American Express'
	  }
	   else if(cardType == 'dinersclub'){
		  cardTypeTemp = 'Diners Club'
	  }
	   else if(cardType == 'mastercard'){
		  cardTypeTemp = 'Master Card'
	  }
	  else if(cardType == 'discover'){
		  cardTypeTemp = 'Discover'
	  }
	 // console.log("cardTypeTemp >>>> " + cardTypeTemp)
	  $("#payment-card").val(cardTypeTemp);
	  cardValidateFirst();
	};

	setCardType1 = function(e) {
	  var allTypes, card, cardType, target, val;
	  target = e.target;
	  val = QJ.val(target);
	  cardType = Payment.fns.cardType(val) || 'unknown';
	  ...
	  var cardTypeTemp = "";
	  //console.log("cardType 2>>>> " + cardType)
	  if(cardType == 'visa'){
	...
	//  console.log("cardTypeTemp 2>>>> " + cardTypeTemp)
	  $("#payment-card2").val(cardTypeTemp);
	  cardValidateSecond();
	};
	Payment = (function() {
	  function Payment() {}
	  ...
	  Payment.formatCardNumber1 = function(el, maxLength) {
	    Payment.restrictNumeric(el);
	    QJ.on(el, 'keypress', restrictCardNumber(maxLength));
	    //QJ.on(el, 'keypress', formatCardNumber(maxLength));
	    //QJ.on(el, 'keydown', formatBackCardNumber);
	    QJ.on(el, 'keyup blur', setCardType1);
	    QJ.on(el, 'paste', reFormatCardNumber);
	    return el;
	  };
...
function cardValidateFirst(){
	if($("#payment-card").val()=="American Express"){
                 ...
                 $("#ccvimg").attr("src", src);
                 $("#tooltip").html("<a href=\"\" class=\"text_link\">3/4 Digit Number From Your Card <span></span> </a>");
...
function cardValidateSecond(){
	
	if($("#payment-card2").val()=="American Express"){
            		   var src = "/resources/images/ccv-img2.gif";
                       $("#ccvimg2").attr("src", src);
                       $("#tooltip2").html("<a href=\"\" class=\"text_link\">4 Digit Number From Your Card<span></span></a>");
           		 ...
           		 var src = "/resources/images/ccv-img.gif";
                 $("#ccvimg2").attr("src", src);
                 $("#tooltip2").html("<a href=\"\" class=\"text_link\">3/4 Digit Number From Your Card<span></span></a>");
                 $("#tooltipm2").html("<span class=\"ccv-card\">3/4 Digit Number From Your Card<span class='cardImg'></span></span>");
        	    }else{
            		   var src = "/resources/images/ccv-img.gif";
                       $("#ccvimg2").attr("src", src);
                       $("#tooltip2").html("<a href=\"\" class=\"text_link\">3 Digit Number From Your Card<span></span></a>");
