    	...
    	if(_usc == 'Offline'){
    		...
    		if(_ssi == 93){
    			var select = _.filter(ca, function(obj){
        			return ((obj.CarReference.VehicleTypeEnum == _svt) && (obj.CarReference.VendorCode == _svc) && (obj.CarReference.RouteStationLst[0].LocationID == _sli));
            	});
    			...
    			var select = _.filter(ca, function(obj){
        			return ((obj.CarReference.VehicleTypeEnum == _svt) && (obj.CarReference.VendorCode == _svc) && (obj.CarReference.RateCode == _src) && (obj.CarReference.RatePlan == _srp));
            	});
    		...
    		if((_svc != '') || (_svt != '')) {
        		var select = _.filter(ca, function(obj){
            		if((_svc != '') && (_svt != '')) {
            			return ((obj.CarReference.VehicleTypeEnum == _svt) && (obj.CarReference.VendorCode == _svc));
            		} else if(_svc != ''){
            			return (obj.CarReference.VendorCode == _svc);
            		} else if(_svt != ''){
            			return (obj.CarReference.VehicleTypeEnum == _svt);
            		}
            	});
