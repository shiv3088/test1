...
function ddlTypejourneyChange(a) {
    if ("1" == a) {
        ...
        var g = ($.datepicker.formatDate("dd-mm-yy", returnsDate));
...
function submitForm() {
    var a = $("#flightSearch").validate({
        ...
        b = parseInt($("#sub1").val());
    if (0 == b) return messhow && (messhow = !1, $.notify("Booking flights for an unaccompanied minor? Some airlines have restrictions on children under the age of 18 years traveling alone. If you have any questions, please <a href='/contact' target='_blank'>call us</a>. Otherwise please include at least 1 adult then hit 'Search'.", "warning")), !1;
    if (a.form()) {
...
function unaccompanied() {
    ...
    messhow && (messhow = !1, $.notify("Booking flights for an unaccompanied minor? Some airlines have restrictions on children under the age of 18 years traveling alone. If you have any questions, please <a href='/contact' target='_blank'>call us</a>. Otherwise please include at least 1 adult then hit 'Search'.", "warning"));
}
...
$('#ow').click(function(){
	...
	var dt_from = $.datepicker.formatDate('dd-mm-yy', returnsDate);
	var checkInDate_from = $.datepicker.formatDate('dd-mm-yy', checkInDate);
...
$(function () {
    ...
    $("#returnDateDiv").click(function () {
        ...
        onClose: function () {
			...
			$("#returnDateText").html(b.getDate()+" "+month_names[b.getMonth()]+" "+b.getFullYear());
        }
    })
...
var dt_to = $.datepicker.formatDate("dd-mm-yy", new Date),
    dt_from = $.datepicker.formatDate("dd-mm-yy", returnsDate),
    checkInDate_from = $.datepicker.formatDate("dd-mm-yy", checkInDate);
    ...
    myapp.controller("dealCtrl", ["$http", "$window", "$scope", "localStorageService", "$timeout","$filter", function (a, b, c, d, e,f) {
        ...
        c.getDeal = function (b, d) {
  	        ...
  	        if(checkMonth(id.TravelDate)){
  		        c.departDate=id.TravelDate;
  		    	  ...
  		    	  var mx = 2; 
  			        ...
  			        var dt_to = $.datepicker.formatDate('dd-mm-yy', minDate);
  		    	   c.departDate=dt_to;
  		       }
          ...
          return "true" == a ? "2" : "1"
            ...
            a.get("/PostDeals/" + b).success(function(a) {
            	...
            	/*if (c.dealList = a, null != d.get("lkfhistory")) {
                    ...
                    index=index-1;
                        ...
                        var i = h[f.getUTCDay()],
                            l = $.datepicker.formatDate("dd-mm-yy", checkInDate),
                            m = $.datepicker.formatDate("dd-mm-yy", f);
	        ...
	        var  maxDate = new Date();
	         maxDate.setMonth(maxDate.getMonth() + x);
              ...
              //  var js = 2;
		        ...
		        //c.returnDate = $.datepicker.formatDate("dd-mm-yy", returnsDate);
            ...
            var newDateDep = addDays(new Date(), 5);
            var newDateRet = addDays(new Date(), 10);
            
            //console.log("newDateDep : "+newDateDep+" newDateRet : "+newDateRet);
            //console.log("new Date(depart) : "+new Date(depart)+" new Date(ret) : "+new Date(ret));
            
            if (new Date(depart) < newDateDep) {
                var departDate = f('date')(newDateDep, 'd-M-yyyy');
            }
            else {
            	alert()
            ...
            if (trip == 'RoundTrip') {
                ...
                if(new Date(ret) < newDateRet){
                	document.getElementById('returnDate').value = f('date')(newDateRet, 'd-M-yyyy');                	
                }else{
