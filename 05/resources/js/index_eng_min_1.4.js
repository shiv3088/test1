...
frominnerHTML= frominnerHTML+"<li data-name='"+fromAirportList[i].originAirport+"-"+fromAirportList[i].originAirportName+"' class='checkbox'><label><input  type='checkbox' value='true'><span>"+fromAirportList[i].originAirport+"-"+fromAirportList[i].originAirportName+"</span></label></li>";
		  ...
		  $.each(response, function(i, item) {
			...
			frominnerHTML= frominnerHTML+"<li data-name='"+item.destAirport+"-"+item.destAirportName+"' class='checkbox'><input type='checkbox' value='true'><span>"+item.destAirport+"-"+item.destAirportName+"</span></li>";
