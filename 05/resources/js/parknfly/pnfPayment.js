...
function submitForm(){
	...
	var frm = $('form#parknflyBookingRequest');
...
//	localStorage.setItem('ls.paymentPage',JSON.stringify(bookingdata));
	/*
	 ...
	 if($('#currentDevice').val()=="Normal"){
		  $('form#parknflyBookingRequest').attr({action: '/flightbook/'+rndId});  
    }else if($('#currentDevice').val()=="Mobile"){
   	  $('form#parknflyBookingRequest').attr({action: '/m/flightbook/'+rndId});  
    }else if($('#currentDevice').val()=="Tablet"){
   	  $('form#parknflyBookingRequest').attr({action: '/t/flightbook/'+rndId});  
    }else{
   	  $('form#parknflyBookingRequest').attr({action: '/flightbook/'+rndId});  
    }
	 bookButtonSetSeats();
    //  $('form#booking').attr({action: '/flightbook/'+rndId});    
      $('form#parknflyBookingRequest').submit();
     */
	 frm.submit();
	 }
...
//	console.log("totalValue:"+totalValue);
	...
	// alert("Total:"+totbsp.toFixed(2));
     ...
     {
    	 document.getElementById('publishedFare').innerHTML="<h4><i class='fa fa-"+cls+"'></i>"+putThousandsSeparators((convRatio*totbsp).toFixed(2))+"</h4>";
	    // document.getElementById('publishedFareMsg').innerHTML ="<h7><i class='fa fa-"+cls+"'></i>"+putThousandsSeparators((convRatio*totbsp).toFixed(2))+"<h7>";
...
//	alert("a totalValue:"+totalValue);
     ...
     ele.value = (convRatio*totbsp).toFixed(2);
