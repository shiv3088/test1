...
.constant('toasterConfig', {
    ...
    'icon-classes': {
        ...
        alert: 'toast-alert',
        almostsold: 'toast-almost-sold',
        bestprice: 'toast-best-price',
        compare: 'toast-compare',
        herry: 'toast-herry',
        people: 'toast-people',
        popular: 'toast-popular',
        secure: 'toast-secure'
    ...
    return {
        ...
        controller: ['$scope', '$element', '$attrs', function ($scope, $element, $attrs) {
            ...
            $scope.click = function (toaster) {
            	console.log("type:"+toaster.type);
            	if(toaster.type === 'toast-hotel'){
            		
            		$scope.redirectToHotel();
            	}
