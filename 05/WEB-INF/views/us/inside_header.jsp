...
<div class="col-xs-12 visible-xs call_xs_div ">
 ...
 Chat Now</a>
                   ...
                   <li class="toll-free hidden-xs hidden-sm visible-md visible-lg">
                    <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free"> <span class="help_no">24<span>x</span>7</span> 1-888-737-8675
                    </li>
                    <li class="toll-free hidden-lg hidden-md">
                    <a href="tel:1-888-737-8675"> <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free"> <span class="help_no">24<span>x</span>7</span>1-888-737-8675</a>
                    </li>
