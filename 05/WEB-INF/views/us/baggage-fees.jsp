...
.blog-responsive { width: 48%;
    ...
    margin-bottom: 20px;
    margin-right: 20px; }
	.blog-responsive .air-logo { float:left; margin-right:10px; width: 60px; height: 35px; }
...
.baggage_bg .note { font-size:12px; color:#333; }
</style>
            ...
            <div class="text-box">
              ...
              <div class="data table-responsive">
					<div class="blog-responsive blog-head">
						<div class="row">
						  <div class="col-xs-7 pr0">Airline </div>
						  <div class="col-xs-5 text-right">Baggage Details</div> 
						</div>
					</div>
                    ...
                    <div class="blog-responsive">
						<div class="row">
						  <div class="col-xs-8 pr0"><img src="/resources/images/airline/${fn:toLowerCase(baggages.airlineCode)}.gif" alt="${baggages.airlineCode}" class="air-logo"> <span>${baggages.airlineName}</span> </div>
						  <div class="col-xs-4 text-right"><a href="${baggages.webLink}" rel="nofollow" target="_blank">View Policy</a></div> 
						</div>
					</div>
