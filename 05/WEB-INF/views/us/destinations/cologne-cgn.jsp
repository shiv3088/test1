...
<head>
<title>Cheap Flights to Cologne| Cologne Flights | ${data.siteName}</title>
<meta name="description" content="Looking for cheap flights to Cologne? TraveloPick offers best airfare deals on airline tickets to Cologne. Book now to get exciting deals on Cologne flights." />
<meta name="keywords" content="Cheap Flights to Cologne, Flights to Cologne, Cologne flights" />
<meta charset="utf-8">
...
<div class="main">
  ...
  <!-- Banner Box -->
  <div id="banner" style="background-image:url(/resources/images/banner/city/cologne-bg.jpg) ; ">
     <div class="container">
        <div class="row">
          
   <div class="col-xs-12  search_engine">
			<div class="engine-caption">
				<h1> Because Cologne is calling!</h1> 
			</div>
                    ...
                    <c:choose>
                     <c:when test="${length > 1}">
                      ...
                      <c:if test="${length>=8}" >
                       ...
                       <h1> Cheap Flights to Cologne</h1>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<h2>Search Flights to Cologne</h2>
			
					<p>Cologne, founded in 38 B.C., is a bustling city in Germany. This ancient city has learnt toembrace the beauty of the modern world. The structures of the city &ndash; some with old architecture and some with futuristic architecture &ndash; are a testament to this very fact.A remarkable fact about the city is that the University of Cologne is one of the largest and one of the oldest universities in Europe.With the Rhine River coursing through Cologne, the city offers some amazing vistas.The river banks look extra gorgeous after sun down when the lights of the nearby buildings and the ones on the bridge are turned on.The nightlife, the cuisine, the friendly locals, the culture, the history and the intriguing attractions of the city draw in a large number of domestic and international travelers every year. One more thing to look out for while visiting this amazing city are all the fun festivals it hosts. </p>
					
					<p>The top attractions of the city includeCologne Cathedral, Museum Ludwig, Br&uuml;hl Castle, Cologne Chocolate Museum, Cologne Zoological Garden, Roman-Germanic Museum, Great St. Martin Church, Duftmuseum im Farina Haus and Wallraf-Richartz Museum. Take a flight toCologne and explore everything this beautiful city has to offer.</p>
