...
<head>
<title>Cheap Flights to Frankfurt| Frankfurt Flights | ${data.siteName}</title>
<meta name="description" content="Looking for cheap flights to Frankfurt? TraveloPick offers best airfare deals on airline tickets to Frankfurt. Book now to get exciting deals on Frankfurt flights." />
<meta name="keywords" content="Cheap Flights to Frankfurt, Flights to Frankfurt, Frankfurt flights" />
<meta charset="utf-8">
...
<div class="main">
  ...
  <!-- Banner Box -->
  <div id="banner" style="background-image:url(/resources/images/banner/city/frenkfurt-bg.jpg);  ">
     <div class="container">
        <div class="row">
	...
	<div class="col-xs-12  search_engine">
			<div class="engine-caption">
				<h1> Because Frankfurt is calling!</h1> 
			</div>
                    ...
                    <c:choose>
                     <c:when test="${length>1}">
                      ...
                      <c:if test="${length>=8}" >
                       ...
                       <h1> Cheap Flights to Frankfurt</h1>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<h2>Search Flights to Frankfurt</h2>
			
					<p>Frankfurt, a central German city, may not be in every international travelers bucket list but certainly deserves a place there.Dating back to the 1st century, the city's skyline is filled with high-rises,and it confirms the fact that time has only made this place bigger and better.The city is famous for a number of delicious dishes that you absolutely need to taste while vacationing there. Party lovers would be delighted to know that a number of vibrant bars and nightclubs grace the city making it easy for them to dance the night away anytime they want to.The city also hosts a number of festivals that keep you entertained during your trip. Amongst all the interesting and exciting festivals and events the city hosts, one of the most prestigious ones is theFrankfurt Book Fair, which is regarded asone of the most significant publishing events in the world.</p>
					
					<p>Having a wide variety of attractions (museums, historically significant structures, art galleries, parks and shopping options), Frankfurt is deemed to be one of the most desired places to travel to in Europe.For the ones who arenot sure about which attractions to visit while on a Frankfurt trip, we've mentioned some of the best ones here. The top attractions of Frankfurt include R&ouml;mer, Palmengarten, Main Tower, R&ouml;merberg, Goethe House, St&auml;del Museum,Frankfurt Cathedral, Eiserner Steg and Frankfurt Zoological Garden.</p>
