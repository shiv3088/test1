               ...
               <li class="dropdown hidden">
                <a href="#myModalLogin" data-toggle="modal" ><i class="fa fa-comments" aria-hidden="true"></i> Login</a>
                   ...
                   <li class="toll-free hidden-xs hidden-sm hidden-md visible-lg">
                    <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free">1-888-737-8675
                    </li>
                    <li class="toll-free hidden-lg">
                    <a href="tel:1-888-737-8675"> <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free"> 1-888-737-8675</a>
                    </li>
      ...
      <ul class="nav nav-pills nav-stacked menu-stacked col-sm-2 col-xs-12 no-padding">
        ...
        <div class="tab-content col-sm-9 col-xs-12 no-padding"><!-- start tab content -->
            ...
            <ul>
			 ...
			 <li><a href="/cheap-flights-to-louisville-sdf"><i class="fa fa-caret-right" aria-hidden="true"></i>Flights to Louis Ville</a></li>
            ...
            <ul>
			 ...
			 <li><a href="/cheap-flights-to-saltlakecity-slc"><i class="fa fa-caret-right" aria-hidden="true"></i>Flights to Salt Lake City</a></li>
                    ...
                    <div id="myTabContent" class="tab-content"><!-- start of tab_content -->
                              ...
                              <div class="col-sm-12 col-xs-12"><!-- start of col_1 -->
                                  <form><!-- start of form -->
                                      ...
                                      <div class="form-group no-margin">
                                          <input type="password" class="form-control login_input_div" id="password" name="password" placeholder="Enter Password">
                                      </div>
                                      <div class="checkbox">
                                          <label>
                                      ...
                                      <button type="submit" class="btn btn_logn btn-block margin-bottom">Login</button>
                        ...
                        <div class="tab-pane fade" id="create"><!-- start of content_2 -->
                            <div class="col-xs-12 no-padding">
                                <form role="form" class="padding-md-bottom padding-md-top"><!-- start of form -->
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                                        	<button type="submit" class="btn btn_logn btn-block">Submit</button>
                                        </div>
                                    </div>
                                </form><!-- end of form -->
                            </div>
