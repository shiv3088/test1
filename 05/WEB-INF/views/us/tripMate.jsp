...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
  <div class="resultsBox" >
  	  <c:choose>
					...
					<c:forEach items="${booking.insurancePricing}" var="insurancePricing" varStatus="tripM">
					...
					<i class="fa fa-<c:out value="${dollar}"/>" ></i><c:out value='${adultTripMate}' /></small> 
						...
						<fmt:formatNumber var="tripTotal" type="number" minFractionDigits="2" maxFractionDigits="2" value="${booking.fare.grandTotal * curRsponse}" />
						<div class="tripmate_radio" id="insurance_radio">
						<div class="add-mcp inputSet">
                       
						   <label onclick="macpSet('TM','Y','Y');radioSelect('TripMateYes');" >
						...
						<div class="remove-mcp inputSet">	
						 					 
						 <label onclick="macpSet('TM','N','N');radioSelect('TripMateNo');" ><form:radiobutton path="TripMate" id="TripMateNo" value="No" onclick="macpSet('TM','N','N');" /><span> <b>No,</b> I would risk my entire trip <i class="fa fa-<c:out value="${dollar}"/>" ></i><c:out value='${tripTotal}' /></span></label>
