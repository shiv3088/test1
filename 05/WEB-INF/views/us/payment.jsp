...
.taxes-fees { position: absolute; top: 0; right: 0; margin: 14px 14px 14px 0; font-size:12px; color: #37d381; text-decoration:underline; }
...
<script>
	...
	<script>
  	$(document).ready(function(){
		...
		$('.upa_airline_tab a').click(function(){
		 $('.upa_airline_tab a').parent().removeClass('active');
		...
		$('.tab2').click(function(){
			...
			$('#tab3, #tab1,#tab4,#tab5,#tab6').removeClass('active');
		})
		$('.tab3').click(function(){
			$('#tab3').addClass('active');
			$('#tab2, #tab1,#tab4,#tab5,#tab6').removeClass('active');
		
		})
		$('.tab4').click(function(){
			$('#tab4').addClass('active');
			$('#tab2, #tab1,#tab5,#tab3,#tab6').removeClass('active');
		
		})
		$('.tab5').click(function(){
			$('#tab5').addClass('active');
			$('#tab2, #tab1,#tab4,#tab3,#tab6').removeClass('active');
		
		})
		$('.tab6').click(function(){
			$('#tab6').addClass('active');
			$('#tab2, #tab1,#tab4,#tab3,#tab5').removeClass('active');
		})
		
		//upa popup
		$('.upa_images li a').click(function(){
				$('#upaModal').show();
			...
			$('#upaModal button.close').click(function(){
				$('#upaModal').hide();
    ...
    function noBack() {
      ...
      //  window.history.go(-1);
         var path=window.location.origin;
		  ...
		  var url=path+"/us/search/id/"+rndId+"";	
...
&nbsp; &nbsp;  OR  -->
      &nbsp; &nbsp; <a href="/us" class="btn btn-primary btn-lg searchbtn">Go to Home</a> </div>
  </div>
</div>
                    ...
                    <div class="row">
					 ...
					 <!--<div class="col-sm-1">
                      ...
                      <div class="col-sm-5 col-xs-8">
						...
						<div class="major-airline img-align-xs">
                          <c:choose>
                      ...
                      <div class="col-sm-2 col-xs-4 col-sm-push-5">
                            ...
                            <c:choose>
                              ...
                              <c:when test="${flight.techStops == '1'}"><u>One Stop</u>
                                <c:forEach items="${flight.techStopDetails}" var="tech" varStatus="ts"> <span class="one-stop-air-hover popover left"><i class="icon icon-arrow arrow"></i> <em>Stops In</em><br/>
                                  ...
                                  Arr <em class="time">
                                  <fmt:formatDate value="${techArr}" pattern="hh:mm a" />
                                  </em>Dep <em class="time">
                                  <fmt:formatDate value="${techDep}" pattern="hh:mm a" />
                                  </em><br/>
                                  </span> </span> </c:forEach>
                              </c:when>
...
<li>No seat selection</li>
                    			...
                    			<c:if test="${flight.flightDuration > 0}">
                      ...
                      <div class="col-sm-5 col-xs-12 col-sm-pull-2">
                        <div class="row">
                          <div class="col-xs-7">
                            <div class="city">
				   ...
				   <div class="col-md-12 col-lg-3">
					   <ul class="upa_images">
					   <c:forEach items="${flight.routeMedia}" var="routeImg" varStatus="loop">
					   		 <c:if test="${loop.index <= 3}">
					   		<li><a data-tab="tab${departSegUpa}" data-image="image${loop.index}" href="javascript:void(0);" onClick="ga('send', 'event', { eventCategory: 'UPA', eventAction: 'click', eventLabel: 'payment'});"><img src="${routeImg.thumbURL}" alt="" />
					   		<c:if test="${loop.index == 3}">
					   		<span>+${flight.routeMedia.size()-3} More</span>
					   		</c:if>
					   		</a></li>
					   		</c:if>
					   		</c:forEach>
...
<li>No seat selection</li>
				   ...
				   <ul class="upa_images">
					   		 <c:forEach items="${flight.routeMedia}" var="routeImg" varStatus="loop">
					   		 <c:if test="${loop.index <= 3}">
					   		<li><a data-tab="tab${departSeg}" href="javascript:void(0);" onClick="ga('send', 'event', { eventCategory: 'UPA', eventAction: 'click', eventLabel: 'payment'});"><img src="${routeImg.thumbURL}" alt="" />
					   		<c:if test="${loop.index == 3}">
					   		<span>+${flight.routeMedia.size()-3} More</span>
					   		</c:if>
					   		</a></li>
      ...
      <div class="resultsBox">
        <div class="passenger_detail">
		 ...
		 <div class="tsa-section1">
          ...
          <!-- Additional Service Request-->
          <div class="information"><b>Important-</b>U.S. Transportation Security Administration (TSA) Secure Flight program now mandates all travelers to provide date of birth and gender as in the Passport or Government issued photo ID. (Privacy Policy)</div>
        </div>
      </div>
...
function siftingdiv(){
		if($(window).width() < 992)
	{
  		$('#priceSummarytop').insertAfter('#kamlesh');
		// $('#main_price').removeClass('right_price')
	}
	
	else{
	  $('#priceSummarytop').insertBefore('#shiftPrice');
...
<!--Price Shifting in SM & XS-->
            ...
            <div class="billing-sequre">
              ...
              <div class="row">
                ...
                <div class="col-sm-4 col-xs-12 margin_mobile form-group"> <font class="validation_star-lg" color="red">*</font>
                  <form:input path="payment.postalCode" id="payment_postalCode" maxlength="10" class="form-control alphanumerics text-box card_type col-xs-12" placeholder="Postal/Zip Code" type="tel" name="Payments.Address1" data-val-required="Enter <b>billing address</b>" data-val-length-min="5" data-val-length-max="80" data-val-length="Enter billing address length should be 5-80 characters" data-val="true" />
                  <span class="field-validation-valid" data-valmsg-replace="true" data-valmsg-for="Payments.Address1"></span> </div>
              </div>
        ...
        <div class="resultsBox">
		  ...
		  <div class="cloudeflare-ss hidden-xs hidden-sm"><img src="/resources/images/cloudflare-safe-2.png"></div>
          ...
          <div class="creditinformation"><i class="fa fa-shield"></i> Your card information is protected by a Secure SSL Encrypted by GoDaddy</div>
        </div>
          ...
          <div class="content payment_detail">
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-4 col-xs-12 margin_mobile">
                <div class="form-group-icon-left form-group-filled ">
                  <form:input path="contact.mobile" id="contact_mobile" minlength="10" placeholder="Alternate Phone"  maxlength="15" class="form-control text-box card_type col-xs-12 numbersOnly" type="tel" name="Payments.Address1" data-val-required="Enter <b>billing address</b>" data-val-length-min="5" data-val-length-max="80" data-val-length="Enter billing address length should be 5-80 characters" data-val="true" />
                  <span class="field-validation-valid" data-valmsg-replace="true" data-valmsg-for="Payments.Address1"></span></div>
              </div>
            </div>
            <div class="row form-group">
		...
		<p>Please confirm the dates and times of flight departures are accurate, also confirm that the names of traveler(s) are accurate. Tickets are non-transferable and any change in the name of traveller is not permitted. Date and routing changes will be subject to airline penalties and our service fees. Fares are not guaranteed until ticketed. All our service fees and taxes are included in the total ticket cost. For major airlines - tickets may be refunded if requested within twenty four (24) hours from the time of purchase at no cost, however, if the customer decides to cancel a ticket after 24 hours from the time of booking, a cancellation fee will be charged. For low cost carriers (LCC), ticket will be non-refundable once booked.</p>
        </div>
        ...
        <div class="bottom-text col-xs-12 text-center visible-lg">
          ...
          <p class="depture checkbox">By clicking, <b>Book Now</b> I agree that I have read and accepted ${data.siteName} &nbsp; <a class="text_link" href="/us/terms-and-conditions" target="_blank">Terms &amp; Conditions</a> and <a class="text_link" href="/us/privacy-policy" target="_blank">Privacy Policy</a>. <br />
        ...
        <div class="col-xs-12">
          ...
          <div class="col-sm-12 col-md-6 text-center">
			...
			<div class="  text-secure "> Your payment details are secured via 256 Bit encryption by GoDaddy </div>
		...
		<!--Price Summary Start-->
		<div id="shiftPrice"></div>
      <div id="priceSummarytop" class="faredetail resultsBox">
  ...
  <c:if test="${totMco1  < 10.00}"><input type="hidden" value="1" id="callpopupopen"/></c:if>
        ...
        <c:if test="${booking.adult > 0}">
          <div class="row traveler-fees-toggle">
            ...
            <div class="col-xs-8">
              ...
              Traveler(s) : Adult <i class="fa fa-angle-double-up"></i> </div>
        ...
        <c:if test="${booking.child > 0}">
          ...
          <div class="row traveler-fees-toggle">
            <div class="col-xs-8 ">
              ...
              Traveler(s) : Child <i class="fa fa-angle-double-up"></i> </div>
            <div class=" col-xs-4 text-right"> <span> <i class="fa fa-<c:out value="${dollar}"/>"></i></span>
        ...
        <c:if test="${booking.infant > 0}">
          ...
          <div class="row traveler-fees-toggle">
            <div class="col-xs-8">
              ...
              Traveler(s) : Infant <sup>LAP</sup> <i class="fa fa-angle-double-up"></i> </div>
        ...
        <c:if test="${booking.infantWs > 0}">
          ...
          <div class="row traveler-fees-toggle">
            <div class="col-xs-8">
              ...
              Traveler(s) : Infant <sup>SEAT</sup> <i class="fa fa-angle-double-up"></i> </div>
            <div class=" col-xs-4 text-right"> <span> <i class="fa fa-<c:out value="${dollar}"/>"></i></span>
        ...
        <div class="coupon_code row hidden" ng-disabled="isDisabled">
		...
		<!--Price Summary End-->
          ...
          <div class="resultsBox hidden-xs hidden-sm">
              ...
              <div class="content">
                ...
                <div class="new-list-view text-center"><img src="/resources/images/cloudflare-footer-logo-black.png"></div>
          ...
          <div class="resultsBox hidden-xs hidden-sm">
              ...
              <div class="content">
                <div class="need-h-support">
                  ...
                  <div class="call-no">
                    <a href="tel:
+1-888-737-8675"><label>Call Us Toll Free 24/7</label>
...
<div id="popup_baggage_fees" class="modal fade hidden-lg" role="dialog">
  <div class="modal-content">
    ...
    <jsp:include page="/us/baggage-fees-popup?airline=${booking.bagAirline}"></jsp:include>
  </div>
</div>
<!-- Tax Fees popup-->
...
<script src="/resources/us/js/payment_tf_1.9_5.js"></script>
...
$('html,body').animate({
	scrollTop: $("#priceSummarytop").offset().top - 50},
	'slow');
});
});
