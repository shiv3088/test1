...
<div class="col-xs-12 visible-xs call_xs_div ">
			...
			<!-- <div class="col-xs-6 text-center ">
				<a href="tel:1-888-737-8675">
					<i class="fa fa-phone"></i> 1-888-737-8675
				</a>
			</div> -->
			
			<div class="col-xs-6 text-center ">
				<a href="tel:${data.tfnNo}">
					<i class="fa fa-phone"></i> ${data.tfnNo}
				</a>
			</div>
 ...
 Chat Now</a>
                   ...
                   <li class="toll-free hidden-xs hidden-sm visible-md visible-lg">${data.tfnNo}

                    <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free"> <span class="help_no">24<span>x</span>7</span> ${data.tfnNo}
                    </li>
                    <li class="toll-free hidden-lg hidden-md">

                    <a href="tel:${data.tfnNo}"> <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free"> <span class="help_no">24<span>x</span>7</span>${data.tfnNo}</a>
                    </li>
    ...
    <div id="myModalLogin" style="" class="modal fade" role="dialog">
      <div class="modal-dialog popu_width row">
                ...
                <div class="col-xs-12 no-padding"><!-- start of well -->
                    ...
                    <div id="myTabContent" class="tab-content"><!-- start of tab_content -->
                        ...
                        <div class="tab-pane fade" id="create"><!-- start of content_2 -->
                            <div class="col-xs-12 no-padding">
                                <form name="myForm" id="myForm" role="form" class="padding-md-bottom padding-md-top"><!-- start of form -->
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4  margin-sm-top">
                                            <span class="checkbox">
                                                <label>
                        ...
                        <div class="tab-pane padding-md-top padding-md-bottom fade" id="forgot"><!-- start of content_3 -->
                            <div class="row"><!-- start of row -->
                              <div class="col-xs-12"><!-- start of col_1 -->
        ...
        <div class="modal-content no-border-radius no-padding col-sm-5 register_div no-border no-box-shadow hidden-xs"><!-- start of register_content -->
            <div class=" col-xs-12 login_padding">
...
<!--  <div id="appId" class=" hidden-lg hidden-md hidden-sm"  style="width:100%; background:rgba(0,0,0,0.8); z-index:9 !important; min-height:20px; display:none; height:auto; padding:10px; border-bottom:2px solid #88b230; margin-top:40px; position:absolute; top:10px;">
