		...
		<%-- <c:choose>
			<c:when test="${hotelBookingRequest.itinNumber =='X'}">
				<div class="titleBlock_error">
				 ...
				 <p><strong>Status:</strong> Your booking could not be processed due to a credit card decline. Please click on this link to update your credit card details and proceed with this booking. You may also call us back 1-888-737-8675 and we will assist you in processing your ticket.</p>
			</c:when>
			<c:otherwise>
			</c:otherwise>
		</c:choose> --%>
