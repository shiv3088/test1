...
<head>
<title> Flights: Book Flights Reservations on ${data.siteName}</title>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<p>The world is beautiful. And, nobody can escape its bewitching charm. Once smitten, the hunger to see more only goes on to increase. In the pursuit to explore the world, several travel plans take form but several even come down crashing. Much of this misfortune can be attributed to the exorbitant prices of flights. People often cite the expenses involved in flying to a destination as the prime deterrent to make travel a reality. But, it seems a tad bit unfair that travel plans are stashed because flights are expensive. Doesn't it? Well, we totally feel so. And, that is why Travelopick has stepped in to ensure that nobody ever has to abandon their travel plans just because the many flights out there did not suit their budget. With a wide array of flights to destinations far and wide, you can surely find the one that meets your requirements. Whether you want to fly in leisure on a Business Class or want to accommodate yourself in the comfort of an Economy Class, we have flights that checks off everybody’s requirements. So, the next time you have plans to travel, look no further. Browse through our website and find a suitable flight for yourself at just the right price. Start booking with us now!  </p>
...
<script src="/resources/us/js/inner_engine_en.js?124"></script>
