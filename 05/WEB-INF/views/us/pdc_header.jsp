...
<div class="cookies-strip hidden-xs">Our site uses cookies so we can provide you with the best possible web experience. <a href="/us/cookie-policy" id="cookies" target="_blank">Click here</a> to learn more about how we use cookies.<span class="accept">Accept & Continue</span></div>   
...
<link href="/resources/new-css/country-dropdown.css?v1266" rel="stylesheet" />
...
<div class="cookies-strip hidden-lg hidden-md hidden-sm" style="display:none;"><p>This website uses cookies to ensure you get the best experience. <a href="/privacy-policy?cookies" id="cookies" target="_blank">Learn More</a></p> <span class="accept">Accept</span></div>   
  <div class="col-xs-12 call_xs_div text-right hidden">
   ...
   <a itemprop="url" href="/us/contact" style="color:#fff; padding-right: 15px;"> Support </a>
  </div>
        ...
        <div class="collapse navbar-collapse xs-no-padding" id="myNavbar">
          <ul itemscope itemtype="http://www.schema.org/SiteNavigationElement" class="nav navbar-nav navbar-right top_menu">
		   ...
		   <li class="select-language hidden-xs">
            ...
            <li itemprop="name"> <a class="active" itemprop="url" href="/us"> Flights  </a> </li>
            </c:if>
            
            <c:if test="${data.hoteltab == true}">
            <li itemprop="name"> <a  itemprop="url" href="/us/hotels"> Hotels </a> </li>
            </c:if>
            
            <c:if test="${data.carstab == true}">
            <li itemprop="name"> <a itemprop="url" href="/us/cars"> Cars</a> </li>
            </c:if>
           ...
           <li class="hidden-xs hidden hide"> <span class="help_no ">TOLL FREE (24x7)</span>
				<img src="/resources/images/hotels/tel-icon.png" style="margin-top: 10px; margin-right: 10px; float:left;">
