...
<head>
<title>Easyjet Airlines Flights: Book Easyjet Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Easyjet Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Easyjet Airlines Flights, Cheap Easyjet Airlines Flights, Easyjet Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Easyjet Airlines  takes you!</h1> 
</div>
...
<h1> Easyjet Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Easyjet Airlines</h2>
<p>EasyJet,  founded in 1995, is a British low-cost airline. With a humongous  fleet of 332 aircraft, this popular airline serves about 156  destinations. These destinations are spread across as many as 30  countries. So, it doesn&rsquo;t matter if you&rsquo;re someone who travels  occasionally or someone who&rsquo;s a seasoned globetrotter, you&rsquo;re  bound to find an <strong>EasyJet flight</strong> to your preferred destinations. The headquarters of this airline are  located in Luton, England. </p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers with <strong>EasyJet  flight tickets</strong> are allowed to carry one piece  of carry-on baggage, the dimensions of which cannot exceed 22 x 18 x  10 inches. In addition to this, passengers with Flexi, Upfront and  Extra Legroom Fare, and easyJet Plus cardholders are allowed to carry  an extra item as carry-on baggage, the dimensions of which cannot  exceed 18 x 14 x 8 inches. </p>
<p>Checked baggage fee is  applicable on all pieces of checked baggage for passengers of all the  travel classes. </p>
