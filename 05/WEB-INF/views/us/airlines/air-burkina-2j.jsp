...
<head>
<title>Air Burkina Flights: Book Air Burkina Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Air Burkina. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Air Burkina Flights, Cheap Air Burkina Flights, Air Burkina Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Air Burkina  takes you!</h1> 
</div>
...
<h1> Air Burkina Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Air Burkina</h2>
			<p>Air Burkina, founded in  1967, is the flag carrier of Burkina Faso. Its hub is Ouagadougou  Airport. There are 5 aircraft in its fleet. It serves 9 destinations  (domestic and regional). This air carrier offers a frequent flyer  program by the name of Celestars. </p>
<p><strong>Baggage Policy </strong> </p>
<p>Passengers  with <strong>Air Burkina flight tickets</strong> are allowed to carry one piece of carry-on baggage, not weighing more  than 22 lb. When it comes to checked baggage, Business Class  passengers are allowed to carry a maximum of 110 lb., while Economy  Class passengers are allowed to carry a maximum of 66 lb. </p>
