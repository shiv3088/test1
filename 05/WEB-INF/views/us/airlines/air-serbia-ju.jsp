...
<head>
<title>Air Serbia Flights: Book Air Serbia Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Air Serbia. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Air Serbia Flights, Cheap Air Serbia Flights, Air Serbia Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Air Serbia  takes you!</h1> 
</div>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Air Serbia</h2>
		<p>Air Serbia, founded in  1927, is the flag carrier of Serbia. Its headquarters are located in  Belgrade, Serbia. The hubs of this airline include Ni&scaron; Constantine  the Great Airport and Belgrade Nikola Tesla Airport. With a fleet of  23 aircraft, Air Serbia serves a total of 59 destinations situated in  numerous countries. You can make <strong>Air Serbia  reservations</strong> for any destination you want to;  be it in Austria, Germany, U.S.A., Russia, Sweden or U.K. The air  carrier has codeshare agreements with a number of premium airlines  such as Air France, Air China and Etihad Airways. </p>
<p><strong>Baggage Policy</strong></p>
<p>Business Class passengers  flying aboard <strong>Air Serbia flights</strong> are allowed to carry two pieces of carry-on baggage, while Economy  Class passengers are allowed to carry one piece of carry-on baggage.  The weight of each of the carry-on baggage cannot exceed 18 lb. The  dimensions of the carry-on baggage should not be more than 16 x 9 x  22 inches. In addition to this, passengers are allowed to carry one  personal item, the weight of which does not exceed 9 lb. </p>
<p>Checked baggage for  flights to/from the U.S.A.- All passengers are allowed to carry two  pieces of checked baggage. The maximum weight limit for Business  Class passengers is 70 lb. while for Economy Class passengers, it&rsquo;s  50 lb. The linear dimension of each of the baggage should not exceed  62 inches. </p>
