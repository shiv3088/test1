...
<head>
<title>Air Canada Flights: Book Air Canada Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Air Canada. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Air Canada Flights, Cheap Air Canada Flights, Air Canada Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where Air Canada takes you!</h1> 
</div>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>Air Canada </h2>
<p>Air Canada, the flag  carrier of Canada, is the largest domestic as well as international  airline of Canada serving more than 50 million passengers every year.  With a fleet of over 400 aircrafts, Air Canada has carved a niche for  itself in the aviation industry. The headquarters of the airline is  in Montreal and has its operations carried out at more than 210  airports in six different continents. Air Canada Altitude - the  frequent flyer program of the airline acknowledges the frequent  flyers and bestows them with special travel privileges making it all  the more preferable to make <strong>Air Canada  Bookings</strong>. </p>

<h3>Baggage Policy</h3>
<p>When travelling with Air  Canada, the airline permits the passengers to bring each of a  standard and a personal article aboard. In regard to the checked  baggage, maximum weight of each piece of luggage must not exceed 50  lb (23 kg) and the linear dimensions of the same should not be more  than 62 inches (158 cm). Kindly be informed that the luggage weighing  50 to 70 lb (23 to 32 kg) will be taken as overweight and the bags  measuring 63 to 115 inches&nbsp;(160 to 292 cm) will be accepted  as&nbsp;oversized. It should also be noted that the free baggage  allowance depends on your destination, fare, date of purchasing  ticket and how frequently you travel with the airline. </p>
...
<script src="/resources/us/js/inner_engine_en.js?0855072019"></script>
