...
<head>
<title>Cape Air Flights: Book Cape Air Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Cape Air. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Cape Air Flights, Cheap Cape Air Flights, Cape Air Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Cape Air  takes you!</h1> 
</div>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Cape Air</h2>
			 <p>Cape Air, also known as Hyannis Air Service, Inc., was founded in 1989. The air carrier was founded by three core co-founders named Dan Wolf (a pilot), Craig Stewart (another pilot) and Grant Wilson (an investor). Its headquarters are located in Barnstable, Massachusetts, U.S.A. You can make Cape Air reservations and fly to any of the 35 destinations served by the airline. This airline&rsquo;s hubs are Logan International Airport, Billings Logan International Airport, Nantucket Memorial Airport, St. Louis Lambert International Airport, Luis Mu&ntilde;oz Mar&iacute;n International Airport and Barnstable Municipal Airport. Its focus city is Martha's Vineyard Airport. Cape Air&rsquo;s fleet consists of 94 aircraft. It has codeshare agreements with American Airlines and JetBlue. </p>
<p><strong>  Baggage Policy</strong></p>
<p>Passengers flying on Cape Air flights are allowed to carry one piece of carry-on baggage along with one personal item. The linear dimension of the carry-on baggage cannot exceed 45 inches while the linear dimension of the personal item cannot exceed 36 inches. <br>
  <br>
  Baggage fees are usually applicable on checked baggage. However, passengers flying in C208A aircraft are allowed to carry one piece of checked baggage without any charge. The weight of the checked baggage cannot exceed 50 lb., while its linear dimension cannot exceed 62 inches. </p>
