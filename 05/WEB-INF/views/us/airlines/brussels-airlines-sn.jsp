...
<head>
<title>Brussels Airlines Flights: Book Brussels Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Brussels Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Brussels Airlines Flights, Cheap Brussels Airlines Flights, Brussels Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Brussels Airlines  takes you!</h1> 
</div>
...
<h1> Brussels Airlines Flight Deals</h1>
...
<p>  Brussels Airlines, founded in 2006, is the flag carrier of Belgium. It also happens to be the largest airline in the country. Its hub is Brussels Airport. Even though its fleet consist of 62 aircraft, Brussels Airlines serves about 120 destinations (domestic and international), thanks to its codeshare agreements with many prominent airlines. Make Brussels Airlines reservations and fly to any city you want to. This popular airlines is a member of the airline alliance group- Star Alliance. </p>
<p><strong>  Baggage Policy</strong></p>
<p>Passengers traveling on Brussels Airlines flights are allowed to carry one piece of carry-on baggage along with one personal item. The combined weight of the two carry-ons cannot exceed 26 lb. Bizz&amp;Class and Business Class passengers are allowed to carry two pieces of carry-on baggage along with one personal item. The combined weight of the three carry-ons cannot exceed 35 lb. The dimensions of the baggage cannot exceed 22 x 16 x 9 inches. The dimensions of the personal item cannot exceed 16 x 12 x 4 inches.<br>
  The checked baggage allowance depends on the flight route. For passengers flying on international flights, to/from the U.S.A.- Economy Class and Business Class passengers are allowed to carry one piece of checked baggage, the weight of which does not exceed 51 lb. </p>
