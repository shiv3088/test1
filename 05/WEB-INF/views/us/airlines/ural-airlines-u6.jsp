...
<head>
<title>Ural Airlines Flights: Book Ural Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Ural Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Ural Airlines Flights, Cheap Ural Airlines Flights, Ural Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Ural Airlines  takes you!</h1> 
</div>
...
<h1> Ural Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Ural Airlines</h2>
			<p>Ural  Airlines, founded in 1943, is an airline based in Russia. Its primary  hubs are Koltsovo International Airport and Moscow Domodedovo  Airport, while its secondary hubs include Pulkovo Airport, Zhukovsky  International Airport and Sheremetyevo International Airport. The  airline serves as many as 101 destinations on the planet. So,  travelers have no trouble making <strong>Ural Airlines  reservations</strong> to their favorite cities. There  are 47 aircraft in its fleet. </p>
<p><strong>Baggage Policy</strong></p>
<p>Business Class passengers  with <strong>Ural Airlines flight tickets </strong>are  allowed to carry two pieces of carry-on baggage, while Economy Class  passengers are allowed to carry one piece of carry-on baggage. The  maximum weight limit for Business Class is 33 lb., while for Economy  Class, it is 11 lb. The dimensions of each of the bags cannot exceed  22 x 16 x 8 inches. </p>
<p>When it comes to checked  baggage, Business Class and Premium Economy Class passengers are  allowed to carry two pieces of baggage. Other passengers are allowed  to carry one piece of checked baggage. Passengers with Promo Light  Fare are not allowed to carry any checked baggage free of charge.  They are to pay a baggage fee on checked baggage. The maximum weight  limit for Business Class is 70 lb. The maximum weight limit for  Premium Economy Class and Economy Class is 50 lb. The maximum weight  limit for Promo Fare is 22 lb. The linear dimension of each of the  checked baggage cannot exceed 80 inches. </p>
