...
<head>
<title>Air Baltic Flights: Book Air Baltic Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Air Baltic. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Air Baltic Flights, Cheap Air Baltic Flights, Air Baltic Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Air Baltic  takes you!</h1> 
</div>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Air Baltic</h2>
			<p>Air Baltic, founded in  1995, is the flag carrier of Latvia. Its headquarters are located in  M&#257;rupe municipality, Latvia. Its primary hub is Riga International  Airport, while its secondary hubs include Vilnius Airport and Tallinn  Airport. With a fleet of 40 aircraft, Air Baltic serves about 75  destinations, most of which are located in Europe. So, if you&rsquo;re  planning to tour Europe, then you can book <strong>Air  Baltic flight tickets</strong> for any city you want  to. </p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers flying aboard <strong>Air Baltic flights</strong> are  allowed  to carry one piece of carry-on baggage along with one personal item.  The dimensions of the carry-on bag cannot be more than 22 x 16 x 9  inches. The dimensions of the personal item cannot be more than 16 x  12 x 4 inches. The combined weight of the carry-ons cannot exceed 18  lb.</p>
<p>Business  Class passengers are allowed to carry two pieces of checked baggage,  while Premium Economy Class passengers are allowed to carry only one  piece of checked baggage. Basic Economy Class passengers are not  allowed to carry any free checked baggage. They may purchase one or  more checked baggage. The checked baggage fee may differ depending on  the flight route and flight duration. Irrespective of the travel  class, the weight of each of the checked baggage cannot exceed 44  lb., while its dimensions cannot be more than 39 x 20 x 31 inches. </p> 
