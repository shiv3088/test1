...
<head>
<title>Asiana Airlines Flights: Book Asiana Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Asiana Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Asiana Airlines Flights, Cheap Asiana Airlines Flights, Asiana Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where Asiana Airlines takes you!</h1> 
</div>
...
<h1> Asiana Airlines Flight Deals</h1>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<h2>Asiana Airlines Reservations</h2>
			
					<p>Asiana Airlines, the second largest airline in South Korea, was founded in 1988. The airline’s hubs are Gimpo International Airport and Gimpo International Airport, while its focus cities are Jeju International Airport and Gimhae International Airport. This prestigious airline is a member of the airline alliance group Star Alliance. Travelers who make <b>Asiana Airlines reservations</b> frequently can make good use of their loyalty program called Asiana Club. With about 85 aircraft in its fleet, the airline serves as many as 90 destinations around the world.   </p>
					
					<h4>Baggage Policy</h4>
<p>Passengers with Economy Class <b>Asiana Airlines bookings</b> are allowed to take along 1 piece of carry-on baggage. Passengers traveling in the First and Business Class are allowed to take along 2 pieces of carry-on baggage. The weight of this baggage cannot be more than 22 lb. The linear dimensions of this baggage cannot be more than 45 inches. Checked baggage allowance would differ depending on the class of travel and the route you're traveling in. For flights to and from the U.S.A. Economy Class and Business Class passengers are allowed to take along 2 pieces of checked baggage. First Class Passengers are allowed 3 pieces of checked baggage. The maximum weight limit for Economy Class passengers is 50 lb. while for Business Class and First Class Passengers, it is 70 lb.                 </p>
...
<script src="/resources/us/js/inner_engine_en.js?0807772019"></script>
