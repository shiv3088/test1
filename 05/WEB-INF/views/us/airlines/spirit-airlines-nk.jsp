...
<head>
<title>Spirit Airlines Flights: Book Spirit Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Spirit Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Spirit Airlines Flights, Cheap Spirit Airlines Flights, Spirit Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Spirit Airlines  takes you!</h1> 
</div>
...
<h1> Spirit Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Spirit Airlines</h2>
				 <p>Spirit Airlines, founded  in 1983, is an ultra-low-cost airline based in the U.S. Its  headquarters are located in Miramar, Florida. Its huge fleet consist  of 138 aircraft. Travelers can book <strong>Spirit  Airlines flight tickets</strong> for one of the 76  (domestic and international) destinations it serves. The operating  bases of this popular airline includes Fort Lauderdale&ndash;Hollywood  International Airport, Orlando International Airport, McCarran  International Airport, Detroit Metropolitan Airport, O'Hare  International Airport, Dallas/Fort Worth International Airport and  Atlantic City International Airport. </p>
				<p><strong>Baggage Policy</strong></p>
				<p>Passengers flying aboard <strong>Spirit Airlines flights</strong> are allowed to carry one piece of carry-on baggage along with one  personal item. A baggage fee would be levied on the carry-on baggage,  while the personal item can be brought free of charge. The dimensions  of the carry-on baggage cannot exceed 22 x 18 x 10 inches, while the  dimensions of the personal item should not be more than 18 x 14 x 8  inches. </p>
				<p>Up  to five pieces of checked baggage is allowed to be brought by each  passengers. However, a baggage fee would be levied on each piece of  baggage. The linear dimension of each of the baggage cannot be more  than 62 inches. Its weight cannot exceed 40 lb. </p> 
				</div>
			</div>
		</div>
