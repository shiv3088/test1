...
<head>
<title>Canadian North Airlines Flights: Book Canadian North Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Canadian North Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Canadian North Airlines Flights, Cheap Canadian North Airlines Flights, Canadian North Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Canadian North Airlines  takes you!</h1> 
</div>
...
<h1> Canadian North Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Canadian North Airlines</h2>
<p>Canadian North, founded in 1998, is a Canadian air carrier. Its headquarters are located in Calgary, Alberta. The hubs of this airline are Edmonton International Airport, Iqaluit Airport and Yellowknife Airport. You can make Canadian North reservations and fly to any of the 18 destinations it serves. Its fleet consist of 16 aircraft. The airline offers two different frequent flyer programs for its passengers, named, Aurora Rewards and Aeroplan. This airline&rsquo;s parent company is Inuvialuit Development Corporation (IDC). 
 </p>
<p><strong> Baggage Policy</strong></p>
<p>  Passengers flying in Canadian North flights are allowed to carry one piece of carry-on baggage along with one small personal item. The weight of the carry-on baggage should not exceed 22 lb. Its dimensions should not exceed 9 x 16 x 22 inches. <br>
  <br>
When it comes to checked baggage, passengers flying with Super-Flex Fare are allowed to carry three pieces of checked baggage. Passengers traveling with Flex Fare are allowed to carry two pieces of checked baggage. Passengers traveling with Saver Fare and Pivut Fare are allowed to carry one piece of checked baggage. The weight of each of the checked baggage cannot exceed 50 lb. However, if your itinerary consists of flights operated by Canadian North&rsquo;s partner airlines, then the checked baggage rules may vary. </p>
				</div>
			</div>
		</div>
