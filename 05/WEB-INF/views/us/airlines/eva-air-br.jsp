...
<head>
<title>EVA Air Flights: Book EVA Air Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on EVA Air. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="EVA Air Flights, Cheap EVA Air Flights, EVA Air Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where EVA Air   takes you!</h1> 
</div>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<h2>EVA Air Reservations</h2>
			
					<p>Established in 1989 by Dr. Chang Yung-Fa, EVA Air is a Taiwanese International Airline headquartered at Luzhu in Taiwan. Being a member of one of the world's largest global airline alliances - Star Alliance, EVA is able to provide its passengers access to a huge network of flights operating in 1300 destinations across the globe. The hub of the Evergreen Airways (EVA) is located at Taiwan Taoyuan International Airport. Quality services as well as continuous development have helped the airline to make it to the list of top eight 5-star Airlines worldwide. With its Hello Kitty Jets, EVA Air makes flying more customized and enjoyable for its passengers. So, make <b>EVA Air bookings</b> now.   </p>
					
					<h4>Baggage Policy</h4>
<p>The airline allows its Business Class passengers to carry two pieces of baggage as carry-on while the passengers traveling Economy Class are permitted to bring one piece of baggage with them. Each piece of baggage, though, must not weigh more than 15 lb. and its dimensions must not exceed 9 x 14 x 22 inches. Regarding checked baggage, two pieces of baggage are allowed in Business Class, Premium Economy and Economy Class as long as each piece of baggage doesn't weigh more than 70 lb., 62 lb. and 50 lb. respectively. It should also be noted that the linear dimensions of each piece of baggage must be less than 62 inches.     </p>
