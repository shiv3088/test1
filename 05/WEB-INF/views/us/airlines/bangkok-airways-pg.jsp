...
<head>
<title>Bangkok Airways Flights: Book Bangkok Airways Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Bangkok Airways. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Bangkok Airways Flights, Cheap Bangkok Airways Flights, Bangkok Airways Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Bangkok Airways  takes you!</h1> 
</div>
...
<h1> Bangkok Airways Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Bangkok Airways</h2>
 <p>Bangkok Airways, founded in 1968, is a Thai airline; the headquarters of which are located in Chatuchak, Bangkok, Thailand. It serves a total of 28 destinations including cities like Phuket, Hong Kong, Phnom Penh and Pattaya. If you&rsquo;re planning for an Asian vacation, make Bangkok Airways reservations and fly away to your favorite cities. The primary hub of Bangkok Airways is Suvarnabhumi Airport. Its secondary hubs include Chiang Mai International Airport and Phuket International Airport. </p>
<p><strong>  Baggage Policy</strong></p>
<p>Passengers holding Bangkok Airways flight tickets are allowed to carry one piece of carry-on baggage along with one personal item. The weight of the carry-on bag should not exceed 11 lb. The size restrictions differ depending on the type of aircraft you&rsquo;re flying in. For passengers flying in ATR72 aircraft, the dimensions of the carry-on baggage should not exceed 17 x 11 x 9 inches. For passengers flying in Airbus A319/320 aircraft, the dimensions of the carry-on baggage should not exceed 22 x 14 x 9 inches. <br>
  <br>
  All passengers are allowed to carry one piece of checked baggage. However, for passengers flying in the Blue Ribbon Class (Business Class), the weight limit is 66 lb.; and for passengers flying in the Economy Class, the weight limit is 44 lb. </p>
