...
<head>
<title>Thai Airways Flights: Book Thai Airways Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Thai Airways. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Thai Airways Flights, Cheap Thai Airways Flights, Thai Airways Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Thai Airways  takes you!</h1> 
</div>
...
<h1> Thai Airways Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Thai Airways</h2>
			
				<p>Thai  Airways, founded in 1960, is the flag carrier of Thailand. Its  headquarters are located in Chatuchak, Bangkok, Thailand. The hubs of  this popular airline are Phuket International Airport and  Suvarnabhumi Airport. Thai Airways is a prestigious member of the  international airline alliance group called Star Alliance. With a  fleet of 80 aircraft, the air carrier serves as many as 70  destinations around the world. So, no matter which city you want to  fly to, you&rsquo;re bound to find <strong>Thai Airways  flight tickets</strong> for your trip. The airline  also offers a loyalty program for its loyal customers who fly with  them regularly called Royal Orchid Plus. 
				</p>
				<p><strong>Baggage Policy</strong></p>
				<p>Passengers flying in <strong>Thai  Airways flights</strong> are allowed to carry one  piece of carry-on baggage along with one personal item. The linear  dimension of the carry-on baggage cannot exceed 45 inches, while its  weight should not be more than 15 lb. </p>
				<p>Checked baggage to/from  the U.S.A. and Canada- All passengers are allowed to carry two pieces  of checked baggage. The linear dimension of each of the baggage  cannot exceed 62 inches. For First Class and Business Class  passengers, the maximum weight limit is 70 lb., while for Economy  Class passengers, it&rsquo;s 50 lb. </p>
