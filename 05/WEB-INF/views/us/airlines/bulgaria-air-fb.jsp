...
<head>
<title>Bulgaria Air Flights: Book Bulgaria Air Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Bulgaria Air. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Bulgaria Air Flights, Cheap Bulgaria Air Flights, Bulgaria Air Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Bulgaria Air  takes you!</h1> 
</div>
...
<h1> Bulgaria Air Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Bulgaria Air</h2>
			<p>Bulgaria Air, founded in  2002, is the flag carrier of Bulgaria. Its hub is Sofia Airport,  while its focus cities include Varna Airport and Burgas Airport. The  headquarters of this premium airline are located in Sofia, Bulgaria.  Travelers can make <strong>Bulgaria Air reservations</strong> for any of the 26 destinations served by this airline. Its fleet  consist of 10 aircraft. </p>
<p><strong>Baggage Policy</strong></p>
<p>For passengers with <strong>Bulgaria Air flight tickets </strong>that  include fares without checked baggage- One piece of carry-on baggage  is allowed to be carried along with one personal item. The weight of  the carry-on baggage cannot exceed 22 lb., while its dimensions  cannot be more than 22 x 16 x 9 inches. </p>
<p>For  passengers who hold tickets that include fares for checked baggage-  Business Class passengers are allowed to carry two pieces of carry-on  baggage along with one personal item. The combined weight of the  carry-on baggage cannot exceed 33 lb. The dimensions cannot be more  than 22 x 16 x 9 inches. They are also allowed to carry two pieces of  checked baggage, the weight of which doesn&rsquo;t exceed 70 lb. Economy  Class passengers are allowed to carry one piece of carry-on baggage  along with one personal item. The weight of the carry-on baggage  cannot exceed 22 lb., while its dimensions cannot be more than 22 x  16 x 9 inches. They are also allowed to carry one piece of checked  baggage, the weight of which cannot exceed 50 lb. The linear  dimension of each of the checked baggage cannot me more than 62  inches, irrespective of travel class. </p>
