...
<head>
<title>Aegean Airlines Flights: Book Aegean Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Aegean Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Aegean Airlines Flights, Cheap Aegean Airlines Flights, Aegean Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Aegean Airlines  takes you!</h1> 
</div>
...
<h1> Aegean Airlines Flight Deals</h1>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<p>Aegean Airlines, founded  in 1987, is the flag carrier of Greece. Its hubs are Larnaca  International Airport, Athens International Airport and Thessaloniki  Airport. Its focus cities include Heraklion International Airport,  Rhodes International Airport, Kalamata International Airport and  Chania International Airport. This premium airline flies to as many  as 153 destinations spread all over the world. So, for your next  vacation, make <strong>Aegean Airlines reservations</strong> to a city of your choice. The air carrier has 49 aircraft in its  fleet. It is a member of the airline alliance group called Star  Alliance. </p>
<p><strong>Baggage Policy </strong> </p>
<p>Business Class passengers  flying aboard <strong>Aegean Airlines flights</strong> are allowed to carry two pieces of carry-on baggage, the combined  weight of which cannot exceed 29 lb. The weight of the 1st  bag cannot be more than 18 lb., while the weight of the 2nd  bag cannot be more than 11 lb. The dimensions of the 1st  bag cannot exceed 22 x 18 x 10 inches, while the dimensions of the  2nd bag cannot be  more than 18 x 14 x 8 inches. Passengers may also carry one piece of  carry-on baggage not weighing more than 29 lb. The dimensions of this  bag cannot exceed 22 x 18 x 10 inches. Economy Class passengers are  allowed to carry one piece of carry-on baggage, the weight of which  cannot exceed 18 lb. Its dimensions cannot exceed 22 x 18 x 10  inches. Additionally, all passengers are allowed to carry one  personal item as a carry-on. </p>
<p>Business Class passengers  are allowed to carry two pieces of checked baggage, while Economy  Class passengers are allowed to carry one piece of checked baggage.  The maximum weight limit for Business Class is 70 lb., while for  Economy Class, it&rsquo;s 51 lb. The linear dimension of each of the  baggage cannot exceed 62 inches. There&rsquo;s no free checked baggage  allowance for Economy GoLight passengers. </p> 
