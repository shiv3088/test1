...
<head>
<title>Silver Airways Flights: Book Silver Airways Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Silver Airways. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Silver Airways Flights, Cheap Silver Airways Flights, Silver Airways Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Silver Airways  takes you!</h1> 
</div>
...
<h1> Silver Airways Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Silver Airways</h2>
			
			<p>Silver Airways, founded in  2011, is a U.S. based airline. Its headquarters are located in  Broward County, Florida. The hubs of this air carrier include Tampa  International Airport, Orlando International Airport and Fort  Lauderdale&ndash;Hollywood International Airport. Its fleet consist of  about 26 aircraft. It serves as many as 18 destinations that includes  cities in the U.S.A. and the Bahamas. Some of those destinations are-  Orlando, Tampa, Freeport and Governor's Harbour. For your next beach  vacation, make <strong>Silver Airways reservations</strong> and fly away to your dream destination. Silver Airways has interline  and codeshare agreements with a number of other airlines including  Air Canada, Azul Brazilian Airlines, All Nippon  Airways, Bahamasair, Avianca, American Airlines, JetBlue, Delta Air  Lines, United Airlines and Alaska Airlines. </p>
			<p><strong>Baggage Policy </strong> </p>
			<p>All passengers flying in <strong>Silver Airways flights </strong>are  allowed to carry one piece of carry-on baggage along with one  personal item. The dimensions of the personal item cannot exceed 14 x  19 x 8 inches. </p>
			<p>When  it comes to checked baggage, a service fee is levied on each piece of  baggage. The weight of each of the baggage cannot exceed 50 lb.,  while its linear dimension cannot be more than 62 inches.</p>
