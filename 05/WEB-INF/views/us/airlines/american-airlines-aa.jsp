...
<head>
<title>American Airlines Flights: Book American Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on American Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="American Airlines Flights, Cheap American Airlines Flights, American Airlines Reservations" />
<meta charset="utf-8">
...
<div class="col-xs-12  search_engine">
	<div class="engine-caption">
		<h1>  Fly where American Airlines takes you!</h1> 
	</div>
...
<h1> American Airlines Flight Deals</h1>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<h2>American Airlines  Reservations</h2>
			
					<p>American Airlines, a major American airline, was founded in the year 1926. Its headquarters are located in Fort Worth. One of the world's largest airlines, its fleet consists of a staggering 967 aircraft. It serves as many as 350 destinations worldwide. So, you'll easily be able to make American Airlines reservations to pretty much any destination you want to. The airline provides a frequent flyer program to its loyal customers called the Advantage using which they can avail a number of travel related benefits.   </p>
					
					<h4>Baggage Policy</h4>
<p>Passengers traveling on American Airlines flights are permitted to bring along 1 piece of carry-on baggage in addition to 1 personal item. The dimensions of the carry-on baggage should not be more than 22 x 14 x 9 inches. The dimensions of the personal item should not be more than 18 x 14 x 8 inches. Passengers traveling in the Main Cabin, Premium Economy and Business Class are permitted to take 2 pieces of checked baggage. Passengers traveling in First Class are permitted to take 3 pieces of checked baggage. A checked baggage fee may apply on the baggage of the passengers traveling in the Main Cabin. For passengers traveling in the Business or First Class, the weight limit is 70 lb. For passengers traveling in Economy Class, the weight limit is 50 lb.    </p>
...
<script src="/resources/us/js/inner_engine_en.js?08072019"></script>
