...
<head>
<title>Copa Airlines Flights: Book Copa Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Copa Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Copa Airlines Flights, Cheap Copa Airlines Flights, Copa Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Copa Airlines  takes you!</h1> 
</div>
...
<h1> Copa Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Copa Airlines</h2>
  <p>Copa  Airlines, founded in 1944, is the flag carrier of Panama. Its  headquarters are located in Panama City. This popular air carrier  serves as many as 81 destinations. So, if you want to make <strong>Copa  Airlines reservations</strong> for your next trip, you  can easily do so. Copa Airlines&rsquo; fleet consists of 95 aircraft. Its  hub is Tocumen International Airport, while its focus cities include  Juan Santamar&iacute;a International Airport and El Dorado International  Airport. It is a member of the prestigious airline alliance group  Star Alliance. </p>
<p><strong>Baggage Policy</strong></p>
<p>All passengers flying  aboard <strong>Copa Airlines flights</strong> are allowed to carry one piece of carry-on baggage along with one  personal item. The linear dimension of the carry-on baggage cannot  exceed 46 inches, while the linear dimension of the personal item  cannot exceed 36 inches. </p>
<p>For flights to/from  U.S.A.- Passengers with Economic Promo Fare and Economy Classic Fare  are allowed to carry one piece of checked baggage, the weight of  which cannot exceed 50 lb. Passengers with Economic Full Fare are  allowed to carry two pieces of checked baggage, the weight of which  cannot exceed 50 lb. (each). Executive Class passengers are allowed  to carry two pieces of checked baggage, the weight of which cannot  exceed 70 lb. </p>
