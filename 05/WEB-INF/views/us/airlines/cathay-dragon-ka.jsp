...
<head>
<title>Cathay Dragon Flights: Book Cathay Dragon Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Cathay Dragon. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Cathay Dragon Flights, Cheap Cathay Dragon Flights, Cathay Dragon Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Cathay Dragon  takes you!</h1> 
</div>
...
<h1> Cathay Dragon Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Cathay Dragon</h2>
 <p>Cathay Dragon, founded in 1985, is a Hong Kong based air carrier. Its headquarters are located in Lantau Island, Hong Kong. Its hub is Hong Kong International Airport. With its fleet of 49 aircraft, the airline serves about 51 destinations in different countries around the world. If you&rsquo;re planning for a trip, you can make Cathay Dragon reservations and fly to your dream destination. The airline is a member of one of the leading airline alliance groups called Oneworld. Cathay Dragon offers two different frequent flyer programs to its passengers- Asia Miles and The Marco Polo Club. </p>
<p><strong>  Baggage Policy<br>
  </strong>Passengers flying in Cathay Dragon flights are allowed to carry one piece of carry-on baggage along with one personal item. The dimensions of the carry-on baggage cannot exceed 22 x 14 x 9 inches. The weight limit for the carry-on baggage of the passengers traveling in First Class is 33 lb. The weight limit for the carry-on baggage of the passengers traveling in Business Class is 22 lb. The weight limit for the carry-on baggage of the passengers traveling in Premium Economy Class and Economy Class is 15 lb. <br>
  <br>
  Checked baggage for flights flying to/from the Americas- First Class and Business Class passengers are allowed to carry two pieces of baggage. The weight of each of the baggage should not exceed 70 lb. Premium Economy Class passengers are allowed to carry two pieces of baggage. The weight of each of the baggage should not exceed 55 lb. Economy Class passengers are allowed to carry two pieces of baggage. The weight of each of the baggage should not exceed 50 lb. </p>
