...
<head>
<title>Croatia Airlines Flights: Book Croatia Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Croatia Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Croatia Airlines Flights, Cheap Croatia Airlines Flights, Croatia Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Croatia Airlines  takes you!</h1> 
</div>
...
<h1> Croatia Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Croatia Airlines</h2>
			<p>Croatia  Airlines, founded in 1989, is the flag carrier of Croatia. Its hub is  Zagreb Airport, while its focus cities include Zadar Airport, Split  Airport and Dubrovnik Airport. With a fleet of 12 aircraft, the air  carrier serves about 38 destinations speckled all across Europe. So,  if you plan to backpack across Europe on your next trip, consider  making <strong>Croatia Airlines reservations</strong>.  The airline is a member of the airline alliance group Star Alliance.  Being a premium air carrier, Croatia Airlines offers a frequent flyer  program for the convenience of its customers called Miles &amp; More. </p>
<p><strong>Baggage Policy</strong></p>
<p>Business Class passengers  with <strong>Croatia Airlines flight tickets</strong> are allowed to carry two pieces of carry-on baggage, while Economy  Class passengers are allowed to carry one piece of carry-on baggage.  The weight of each of the bags cannot exceed 18 lb., while its linear  dimension cannot be more than 45 inches. In addition to this,  passengers are also allowed to carry one personal item, the  dimensions of which cannot exceed 16 x 12 x 4 inches.</p>
<p>Checked baggage on  domestic and international flights- Passengers with FlyBizz Fare are  allowed to carry two pieces of baggage not weighing more than 70 lb.  FlyOpti Fare and FlyFlexi Fare passengers are allowed to carry one  piece of baggage not weighing more than 51 lb. The linear dimension  of each of the checked baggage cannot exceed 62 inches. </p>
