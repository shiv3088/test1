...
<head>
<title>Iceland Air Flights: Book Iceland Air Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Iceland Air. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Iceland Air Flights, Cheap Iceland Air Flights, Iceland Air Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Iceland Air  takes you!</h1> 
</div>
...
<h1> Iceland Air Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Iceland Air</h2>
			 
			 <p>Icelandair, founded in  1937, is the flag carrier of Iceland. Its headquarters are located in  Reykjav&iacute;k, Iceland. With a fleet of 36 aircraft, the airline serves  about 48 destinations spread across 16 different countries. You can  make <strong>Icelandair reservations</strong> to any of these cities for your next vacation. Icelandair&rsquo;s hub is  Keflav&iacute;k International Airport. This air carrier offers a frequent  flyer program for its passengers called Saga Club. Icelandair&rsquo;s  parent company is Icelandair Group. </p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers flying in <strong>Icelandair flights</strong> are  allowed to carry one piece of carry-on baggage along with one  personal item. The weight of the carry-on baggage should not be more  than 22 lb., while its dimensions should not exceed 22 x 16 x 8  inches. The dimensions of the personal item should not exceed 16 x 12  x 6 inches. </p>
<p>When it comes to checked  baggage, Economy Class passengers are allowed to carry one piece of  baggage not weighing more than 50 lb. Saga Club members are allowed  to carry two pieces of baggage not weighing more than 70 lb. The  linear dimension of each of the baggage cannot be more than 62  inches.</p>
