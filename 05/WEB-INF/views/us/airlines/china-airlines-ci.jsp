...
<head>
<title>China Airlines Flights: Book China Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on China Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="China Airlines Flights, Cheap China Airlines Flights, China Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     China Airlines  takes you!</h1> 
</div>
...
<h1> China Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About China Airlines</h2>
			<p>China  Airlines, founded in 1959, is the flag carrier of Taiwan. Its  headquarters are located in Taoyuan City, Taiwan. Its hub is Taoyuan  International Airport, while its focus cities include Kaohsiung  International Airport, Songshan Airport and Hong Kong International  Airport. The air carrier covers about 102 destinations. Hence, you&rsquo;re  bound to find <strong>China Airlines reservations</strong> for your favorite cities. The fleet of this major airline consist of  89 aircraft. It offers a frequent flyer program called Dynasty Flyer. </p>
			<p><strong>Baggage Policy</strong></p>
			<p>Passengers traveling in <strong>China Airlines flights</strong> are allowed to carry one piece of carry-on baggage along with one  personal item. The weight of the carry-on baggage cannot exceed 15  lb., while its dimensions cannot be more than 22 x 14 x 9 inches.  However, Business Class passengers are allowed to carry two pieces of  carry-on baggage along with one personal item. </p>
			<p>For flights to/from the  Americas: All passengers are allowed to carry two pieces of checked  baggage. However, Economy Class passengers with Discount Fare are  allowed to carry only one piece of checked baggage. The linear  dimension of each of the baggage cannot exceed 62 inches. The maximum  weight limit for Business Class is 70 lb. The maximum weight limit  for Premium Economy Class is 61 lb. The maximum weight limit for  Economy Class is 50 lb. </p> 
