...
<head>
<title>Finnair Flights: Book Finnair Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Finnair. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Finnair Flights, Cheap Finnair Flights, Finnair Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Finnair  takes you!</h1> 
</div>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Finnair</h2>
			<p>Finnair,  founded in 1923, is the flag carrier of Finland. It also happens to  be the largest air carrier in the country. Its hub is Helsinki  Airport. The airline serves about 132 destinations around the world.  So, finding <strong>Finnair flight tickets</strong> to your favorite cities is incredibly easy. This air carrier&rsquo;s  fleet consist of 83 aircraft. It is a member of the airline alliance  group called Oneworld. </p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers flying in the  Business Class of <strong>Finnair flights</strong> are allowed to carry two pieces of carry-on baggage, the weight of  which cannot exceed 22 lb. Economy Class passengers are allowed to  carry one piece of carry-on baggage, the weight of which cannot  exceed 18 lb. The dimensions of each of the baggage cannot exceed 22  x 18 x 10 inches. Along with this, all passengers are allowed to  carry a personal item the dimensions of which does not exceed 16 x 12  x 6 inches. </p>
<p>For flights to/from North  America: Business Class passengers are allowed to carry two pieces of  checked baggage, while Economy Class passengers are allowed to carry  one piece of baggage. The weight of each of the baggage cannot exceed  50 lb. The linear dimension of the baggage cannot exceed 62 inches. </p>
