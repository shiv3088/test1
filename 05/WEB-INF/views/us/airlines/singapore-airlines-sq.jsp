...
<head>
<title>Singapore Airlines Flights: Book Singapore Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Singapore Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Singapore Airlines Flights, Cheap Singapore Airlines Flights, Singapore Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Singapore Airlines  takes you!</h1> 
</div>
...
<h1> Singapore Airlines Flight Deals</h1>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<p>Singapore  Airlines, founded in 1947, is the flag carrier of Singapore. Its hub  is Singapore Changi Airport. Its huge fleet consist of 127 aircraft.  Singapore Airlines offers its flight operations to about 62  destinations, both domestic and international. So, you can make <strong>Singapore Airlines reservations</strong> to any city you want to. Singapore Airlines offers a frequent flyer  program for its loyal customers called KrisFlyer. </p>
			<p><strong>Baggage Policy</strong></p>
			<p>Suites, First Class and  Business Class passengers are allowed to carry two pieces of carry-on  baggage, while Premium Economy Class and Economy Class passengers are  allowed to carry one piece of carry-on baggage. The linear dimension  of each of the carry-on baggage cannot exceed 45 inches. The weight  of each of the baggage cannot exceed 15 lb. In addition to this,  passengers flying aboard <strong>Singapore Airlines  flights </strong>are also allowed to carry a personal  item such as a ladies&rsquo; handbag, camera bag, umbrella, overcoat,  laptop bag etc. </p>
			<p>Checked baggage for  flights to/from the U.S.A.- Suites, First Class, Business Class,  Premium Economy Class and Economy Class passengers are allowed to  carry two pieces of baggage. The maximum weight limit for each of the  baggage for Suites, First Class and Business Class is 70 lb., while  the maximum weight limit for each of the baggage for Premium Economy  Class and Economy Class is 51 lb. The linear dimension of each of the  checked baggage cannot exceed 62 inches. </p>
