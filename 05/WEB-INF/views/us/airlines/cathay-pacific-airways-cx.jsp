...
<head>
<title>Cathay Pacific Airways Flights: Book Cathay Pacific Airways Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Cathay Pacific Airways. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Cathay Pacific Airways Flights, Cheap Cathay Pacific Airways Flights, Cathay Pacific Airways Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Cathay Pacific Airways  takes you!</h1> 
</div>
...
<h1> Cathay Pacific Airways Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Cathay Pacific Airways</h2>
 
 <p>Cathay Pacific, founded in 1946, is the flag carrier of Hong Kong. Its headquarters are located in Chek Lap Kok, Hong Kong. This premium airline&rsquo;s hub is Hong Kong International Airport, while its focus city is Taoyuan International Airport. The airline offers its services to as many as 77 destinations around the globe. So, you can easily make Cathay Pacific reservations to your preferred cities. Its huge fleet consist of 153 aircraft. The air carrier provides two different loyalty programs to its customers called the Asia Miles and The Marco Polo Club. </p>
<p><strong>  Baggage Policy<br>
  </strong>Passengers with Cathay Pacific flight tickets are permitted to carry one piece of carry-on baggage along with one small personal item. The dimensions of the carry-on baggage should not exceed 22 x 14 x 9 inches. The dimensions of the personal item should not exceed 16 x 12 x 6 inches. For passengers traveling in First Class, the combined weight limit of the carry-ons is 33 lb. For passengers traveling in Business Class, the combined weight limit of the carry-ons is 22 lb. For passengers traveling in Premium Economy Class and Economy Class, the combined weight limit of the carry-ons is 15 lb. <br>
  <br>
  When it comes to checked baggage, First Class and Business Class passengers are allowed to carry two pieces of baggage, with each piece not weighing more than 70 lb. Premium Economy Class passengers are allowed to carry two pieces of baggage, with each piece of baggage not weighing more than 55 lb. Economy Class passengers are allowed to carry two pieces of baggage, with each piece of baggage not weighing more than 50 lb. </p>
