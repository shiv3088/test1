...
<head>
<title>Norwegian Air Flights: Book Norwegian Air Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Norwegian Air. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Norwegian Air Flights, Cheap Norwegian Air Flights, Norwegian Air Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Norwegian Air  takes you!</h1> 
</div>
...
<h1> Norwegian Air Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Norwegian Air</h2>
			<p>Norwegian Air, founded in  1993, is a Norwegian low-cost airline based in Fornebu, Norway. It  also happens to be Norway&rsquo;s largest air carrier. Its many operating  bases include Barcelona&ndash;El Prat Josep Tarradellas Airport,  Aeroparque Jorge Newbery, Gatwick Airport, Los Angeles International  Airport, Helsinki Airport, Adolfo Su&aacute;rez Madrid&ndash;Barajas Airport  and Copenhagen Airport. The airline serves about 148 destinations  spread across different countries. So, you can make <strong>Norwegian  Air reservations</strong> no matter which city you  want to fly to. Norwegian Air&rsquo;s fleet consist of 40 aircraft. </p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers with <strong>Norwegian  Air flight tickets</strong> are allowed to carry one  piece of carry-on baggage along with one personal item. The  dimensions of the baggage should not exceed 22 x 16 x 9 inches, while  the dimensions of the personal item should not be more than 9 x 13 x  8 inches. The combined weight of the two carry-ons should not be more  than 22 lb. for LowFare, LowFare+, Flex, Premium Fare passengers; 33  lb. for PremiumFlex passengers and 18 lb. for passengers of Dubai  flights.</p>
<p>Checked  baggage for international flights: Flex, Premium and PremiumFlex  passengers are allowed to carry two pieces of checked baggage.  LowFare+ passengers are allowed to carry one piece of checked  baggage. The weight of each of the baggage cannot exceed 44 lb.</p>
