...
<head>
<title>Interjet  Airlines Flights: Book Interjet  Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Interjet  Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Interjet  Airlines Flights, Cheap Interjet  Airlines Flights, Interjet  Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Interjet  Airlines  takes you!</h1> 
</div>
...
<h1> Interjet  Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Interjet  Airlines</h2>
			<p>Interjet, founded in 2005,  is the third largest airline of Mexico. Its headquarters are located  in Mexico City, Mexico. <strong>Interjet flights</strong> fly to as many as 55 destinations around the globe. This popular air  carrier&rsquo;s fleet has 69 aircraft. Interjet&rsquo;s hub is Mexico City  International Airport. Its focus cities include Monterrey  International Airport, Miguel Hidalgo y Costilla Guadalajara  International Airport and Canc&uacute;n International Airport. The airline  offers a frequent flyer program named Club Interjet. </p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers with <strong>Interjet  flight tickets </strong>are allowed to carry one piece  of carry-on baggage along with one personal item as carry-ons. The  combined weight of these two pieces of baggage should not exceed 22  lb. The dimensions of the carry-on baggage should not exceed 21 x 15  x 9 inches. </p>
<p>When it comes to checked  baggage, passengers are allowed to carry two pieces, the weight of  which does not exceed 55 lb. Its linear dimension should not be more  than 62 inches.</p>
