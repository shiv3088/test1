...
<head>
<title>Hong Kong Airlines Flights: Book Hong Kong Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Hong Kong Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Hong Kong Airlines Flights, Cheap Hong Kong Airlines Flights, Hong Kong Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Hong Kong Airlines  takes you!</h1> 
</div>
...
<h1> Hong Kong Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Hong Kong Airlines</h2>
			<p>Hong Kong Airlines,  founded in 2006, is a Hong Kong based air carrier. Its hub is Hong  Kong International Airport. The headquarters of this popular airline  is located in Lantau, Hong Kong. With a fleet of 28 aircraft, the  airline offers flights to about 30 destinations in various parts of  the world. So, hop on a <strong>Hong Kong Airlines  flight</strong> for your next trip. The airline offers  a frequent flyer program to its loyal customers known as the Fortune  Wings Club. </p>
<p><strong>Baggage Policy</strong></p>
<p>Business Class passengers  with <strong>Hong Kong Airlines flight tickets</strong> are allowed to carry two pieces of carry-on baggage. Economy Class  passengers are allowed to carry one piece of baggage. The weight of  each of the carry-on baggage should not exceed 15 lb. The dimensions  of the baggage should not exceed 22 x 14 x 9 inches. Additionally,  passengers are also allowed to carry a personal item as a carry-on. </p>
<p>Checked baggage for  flights to/from the U.S.A.- All passengers are allowed to carry two  pieces of checked baggage. However, the maximum weight limit for  Business Class passengers is 70 lb., while for Economy Class  passengers, it is 51 lb. The linear dimension of each of the checked  baggage cannot be more than 62 inches. </p>
