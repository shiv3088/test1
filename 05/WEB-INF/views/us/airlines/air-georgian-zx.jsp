...
<head>
<title>Air Georgian Flights: Book Air Georgian Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Air Georgian. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Air Georgian Flights, Cheap Air Georgian Flights, Air Georgian Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Air Georgian  takes you!</h1> 
</div>
...
<h1> Air Georgian Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Air Georgian</h2>
			<p>Air  Georgian, founded in 1994, is an airline based in Canada. Its hub is  Toronto Pearson International Airport. Its headquarters are located  in Mississauga, Ontario. Its fleet consists of 31 aircraft. Make <strong>Air  Georgian reservations</strong> and fly to any of the  18 destinations (mostly in the U.S.A.) its serves. It provides a  frequent flyer program for its customers called Aeroplan, using  which, passengers can get certain travel-related benefits. It is a  member of the airline alliance group named Star Alliance. This air  carrier has a codeshare agreement with the leading Canadian airline  called Air Canada. </p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers flying aboard <strong>Air Georgian flights</strong> are allowed to carry one piece of carry-on baggage along with one  personal item. The dimensions of the carry-on baggage cannot exceed  22 x 16 x 9 inches, while the dimensions of the personal item cannot  exceed 17 x 13 x 6 inches. </p>
<p>Passengers are allowed to  carry one piece of checked baggage. The weight of this baggage cannot  exceed 50 lb., while its linear dimension should not be more than 62  inches. This checked baggage allowance may differ depending on the  flight route, travel class and status of your frequent flyer program. </p>
