...
<head>
<title>Aer Lingus Flights: Book Aer Lingus Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Aer Lingus. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Aer Lingus Flights, Cheap Aer Lingus Flights, Aer Lingus Reservations" />
<meta charset="utf-8">
 ...
 <div id="banner" style="background-image:url(/resources/images/banner/generic-airline.jpg?v123);"> 
  ...
  <div class="col-xs-12  search_engine">
	<div class="engine-caption">
		<h1>  Fly where Aer Lingus takes you!</h1> 
	</div>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<h2>Aer Lingus Reservations</h2>
			
					<p>Aer Lingus, the flag carrier of Ireland, was founded in 1936. Its headquarters are located at Dublin Airport. The airline has about 51 aircraft in its fleet. It flies to around 93 domestic and international destinations making it easy for you to book <b>Aer Lingus flight tickets</b> to your favorite destinations. Its hub is Dublin Airport and its focus cities include Cork Airport and Shannon Airport.     </p>
					
					<h4>Baggage Policy</h4>
<p>Passengers with <b>Aer Lingus bookings</b> are allowed to bring 1 piece of carry-on baggage along with 1 personal item on their flights. The weight of this baggage cannot be more than 22 lb. Its dimensions cannot be more than 22 x 16 x 9 inches. The dimensions of the personal item cannot be more than 10 x 13 x 9 inches. For passengers traveling Aer Lingus Regional service and the ones traveling connecting from the Aer Lingus service to Aer Lingus Regional service, the carry-on baggage cannot weight more than 15 lb. Its dimensions cannot be more than 19 x 13 x 8 inches. The dimensions of the personal item cannot be more than 10 x 13 x 9 inches. For checked baggage-passengers traveling with Smart Fare or Flex Fare are allowed to take 1 piece of checked baggage the weight of which cannot be more than 50 lb. Passengers traveling in Business Class are allowed to take 3 pieces of baggage the combined weight of which cannot be more than 150 lb.             </p>
...
<script src="/resources/us/js/inner_engine_en.js?29072019"></script>
