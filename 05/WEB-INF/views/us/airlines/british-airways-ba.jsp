...
<head>
<title>British Airways Flights: Book British Airways Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on British Airways. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="British Airways Flights, Cheap British Airways Flights, British Airways Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     British Airways  takes you!</h1> 
</div>
...
<h1> British Airways Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About British Airways</h2>
			 
			 <p>British Airways, founded in 1974, has its headquarters in Harmondsworth, United Kingdom. It is the flag carrier of the U. K. This premium airline&rsquo;s hubs are Heathrow Airport and Gatwick Airport. The airline serves as many as 183 destinations around the world. If you want to make British Airways reservations for your next trip, then you&rsquo;re bound to find a flight for your preferred destination/s. British Airway&rsquo;s humongous fleet consists of 277 aircraft that ensure a safe and comfortable flight. 
 </p>
<p><strong> Baggage Policy</strong></p>
<p>Passengers holding British Airways flight tickets are allowed to carry one piece of carry-on baggage along with one personal item. The weight of the carry-on baggage cannot exceed 51 lb. The dimensions of the carry-on baggage cannot exceed 22 x 18 x 10 inches, while the dimensions of the personal item cannot exceed 16 x 12 x 6 inches. <br>
  When it comes to checked baggage, First Class and Business Class passengers are allowed to carry three pieces of baggage, the weight of which doesn&rsquo;t exceed 70 lb. Premium Economy Class passengers are allowed to carry two pieces of baggage, the weight of which doesn&rsquo;t exceed 51 lb. Economy Class passengers are allowed to carry one piece of baggage the weight of doesn&rsquo;t exceed 51 lb.</p>
