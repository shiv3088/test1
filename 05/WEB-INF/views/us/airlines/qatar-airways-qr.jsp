...
<head>
<title>Qatar Airways Flights: Book Qatar Airways Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Qatar Airways. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Qatar Airways Flights, Cheap Qatar Airways Flights, Qatar Airways Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where   Qatar Airways  takes you!</h1> 
</div>
...
<h1> Qatar Airways Flight Deals</h1>
...
<div class="container">
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<h2>Qatar Airways Reservations</h2>
			
					<p>Qatar Airways, the flag carrier of Qatar, was founded in 1993. Within a short span of time, the airline has reached great heights. Headquartered in Doha, the airline's hub is Hamad International Airport. With a fleet size of 229 aircraft, the airline offers flights to about 172 destinations around the world. So, the next time you plan for a domestic or international vacation, you can easily book <b>Qatar Airways flight tickets. </b>       </p>
					
					<h4>Baggage Policy</h4>
<p>Passengers traveling in the Economy Class are allowed to take along 1 piece of carry-on baggage the weight of which cannot be more than 15 lb. Passengers traveling in Business Class and First Class are allowed to take along 2 pieces of carry-on baggage the weight of which cannot be more than 33 lb. In addition to this, passengers are allowed to take along one personal item. The dimensions of each of the baggage cannot be more than 20 x 15 x 10 inches. Checked baggage allowance depends on the route you're flying in and on the travel class you chose for your travels. For flights flying to and from the U.S.A. and Canada- Passengers flying in all the classes are allowed to take 2 pieces of checked baggage. The linear dimensions of these pieces of baggage cannot be more than 62 inches. For passengers traveling in the Economy Class, the maximum weight limit is 50 lb. For passengers traveling in the Business and First Class, the maximum weight limit is 70 lb.            </p>
...
<script src="/resources/us/js/inner_engine_en.js?081072019"></script>
