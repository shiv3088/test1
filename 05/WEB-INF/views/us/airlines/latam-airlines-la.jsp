...
<head>
<title>LATAM Airlines  Flights: Book LATAM Airlines  Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on LATAM Airlines . Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="LATAM Airlines  Flights, Cheap LATAM Airlines  Flights, LATAM Airlines  Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     LATAM Airlines   takes you!</h1> 
</div>
...
<h1> LATAM Airlines  Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <p>LATAM  Airlines, founded in 2012, is a Chilean airline. It is deemed to be  the largest airline in Latin America thanks to its many subsidiaries  such as LATAM Brasil, LATAM Peru and LATAM Colombia. Its headquarters  are located in S&atilde;o Paulo, Brasil. Its humongous fleet consist of  about 350 aircraft and offers flight operations to numerous  destinations in North America, South America and Europe. For your  next vacation, hop on a <strong>LATAM Airlines flight</strong> to a city of your choice. 
</p>
<p><strong>Baggage Policy</strong></p>
<p>Passengers with <strong>LATAM  Airlines flight tickets</strong> are allowed to carry  one piece of carry-on baggage along with one personal item. The  dimensions of the carry-on bag cannot exceed 21 x 13 x 9 inches,  while the dimensions of the personal item cannot be more than 18 x 14  x 8 inches. The maximum weight limit for Business Class and Premium  Economy Class passengers is 35 lb. The maximum weight limit for  Economy Class passengers is 17 lb. </p>
<p>On international routes,  Business Class and Premium Economy Class passengers are allowed to  carry three pieces of checked baggage. Economy Class passengers on  flights to/from U.S.A. and South America, with Top Fare and Plus  Fare, are allowed to carry two pieces of checked baggage. Light Fare  passengers are allowed to carry one piece of checked baggage, while  Promo Fare passengers are not entitled to any free checked baggage.  The weight of each of the bags cannot exceed 50 lb. The linear  dimension of each of the bags cannot be more than 62 inches.</p>
