...
<head>
<title>Southern Airways Flights: Book Southern Airways Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Southern Airways. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Southern Airways Flights, Cheap Southern Airways Flights, Southern Airways Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Southern Airways  takes you!</h1> 
</div>
...
<h1> Southern Airways Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Southern Airways</h2>
			
			<p>Southern  Airways, founded in 2013, is a U.S. based airline. Its headquarters  are located in Hernando, Mississippi, and Pompano Beach, Florida. Its  hubs are Pittsburgh International Airport, Palm Beach International  Airport, Memphis International Airport and Baltimore&ndash;Washington  International Airport. Southern Airways&rsquo; fleet consist of 21  aircraft. Travelers can hop on a <strong>Southern  Airways flight</strong> and fly to any of the 23  destinations Southern Airways serves. To name a few- Atlanta, Destin,  Nashville, El Dorado, Hot Springs, Lancaster and Tampa. </p>
			<p><strong>Baggage Policy</strong></p>
			<p>Both, carry-on and checked  baggage allowance depends on the fare chosen by a passenger. However,  all passengers with <strong>Southern Airways flight  tickets</strong> are allowed to carry one personal  item as a carry-on. For Frugal Fare passengers- Either one piece of  carry-on baggage (maximum weight limit- 15 lb.) or one piece of  checked baggage (maximum weight limit- 50 lb.) is allowed. For  Friendly Fare passengers- One piece of carry-on baggage (maximum  weight limit- 15 lb.) and one piece of checked baggage (maximum  weight limit- 50 lb.) are allowed. For Freedom Fare passengers- One  piece of carry-on baggage (maximum weight limit- 15 lb.) and two  pieces of checked baggage (maximum weight limit- 70 lb.) are allowed. </p> 
