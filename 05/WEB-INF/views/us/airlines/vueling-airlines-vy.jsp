...
<head>
<title>Vueling Airlines Flights: Book Vueling Airlines Reservations at ${data.siteName}</title>
...
<div class="engine-caption">
	<h1>  Fly where     Vueling Airlines  takes you!</h1> 
</div>
...
<h1> Vueling Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Vueling Airlines</h2>
			
				<p>Vueling  Airlines, founded in 2004, is a Spanish low cost airline. Its  headquarters are located in Barcelona, Catalonia, Spain. The hubs of  this popular air carrier include Leonardo da Vinci&ndash;Fiumicino  Airport and Barcelona&ndash;El Prat Josep Tarradellas Airport. Vueling  Airlines&rsquo; humongous fleet consist of 125 aircraft. The airline  serves a total of 148 destinations spread across different countries  on the planet. So, whichever cities you want to fly to, you can make <strong>Vueling Airlines reservations</strong> and fly for cheap. It has a number of operating bases some of which  are Alicante&ndash;Elche Airport, Orly Airport, Charles de Gaulle  Airport, Florence Airport and Ibiza Airport. </p>
				<p><strong>Baggage Policy</strong></p>
				<p>Passengers flying aboard <strong>Vueling Airlines flights</strong> are allowed to carry one piece of carry-on baggage along with one  personal item. The dimensions of the carry-on baggage cannot exceed  22 x 16 x 8 x inches. The weight of the carry-on baggage should not  be more than 22 lb. The dimensions of the personal item cannot exceed  14 x 8 x 8 inches. </p>
				<p>No free checked baggage is  allowed to be carried. A baggage fee would be levied on all the  pieces of checked baggage. The amount that is to be paid by the  passenger as baggage fee depends on the flight route and the place  where the passengers choose to check-in the baggage (online or at the  airport). </p>
