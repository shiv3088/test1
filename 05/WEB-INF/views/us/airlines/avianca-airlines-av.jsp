...
<head>
<title>Avianca Airlines Flights: Book Avianca Airlines Reservations at ${data.siteName}</title>
<meta name="description" content="Find the best airfare deals on Avianca Airlines. Book cheap flight tickets and save time & money when you make reservations with ${data.siteName}" />
<meta name="keywords" content="Avianca Airlines Flights, Cheap Avianca Airlines Flights, Avianca Airlines Reservations" />
<meta charset="utf-8">
...
<div class="engine-caption">
	<h1>  Fly where     Avianca Airlines  takes you!</h1> 
</div>
...
<h1> Avianca Airlines Flight Deals</h1>
	...
	<!--  about Start Here -->
		<div class="about-destinationBox">
			...
			<br/>
			 ...
			 <h2>About Avianca Airlines</h2> 
			 
			 <p>Avianca Airlines, founded in 1919, is the flag carrier of Colombia. Headquartered in Bogot&aacute;, the airline has grown manifolds and spread its branches in the form of its numerous subsidiaries. It has also grown in fleet size and the number of destinations served. If you&rsquo;re planning to make an Avianca Airlines reservation, then you can do that easily as it flies to countless cities around the world. Some of those cities include London, Paris, Washington, D.C. etc. This popular air carrier&rsquo;s primary hubs include El Salvador International Airport, Jorge Ch&aacute;vez International Airport and El Dorado International Airport, while its secondary hubs are Mariscal Sucre International Airport and Juan Santamar&iacute;a International Airport. </p>
<p><strong>  Baggage Policy</strong></p>
<p>Passengers traveling aboard Avianca Airlines flights are allowed to carry one carry-on baggage along with one personal item. The linear dimension of the carry-on baggage should not exceed 45 inches. Its weight should not exceed 22 lb. <br>
  <br>
The checked baggage allowance would differ depending on your flight route. For passengers traveling on international flights to/from USA, Canada, Mexico and Spain- Business Class passengers are allowed to carry two pieces of baggage the weight of which does not exceed 70 lb. Economy Class passengers are allowed to carry two pieces of baggage the weight of which does not exceed 50 lb. The linear dimension should not be more than 62 inches.</p>
