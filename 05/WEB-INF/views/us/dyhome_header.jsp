...
.ui-datepicker .ui-datepicker-title select { width:70px !important; margin-right:10px !important; }
        ...
        <nav class="navbar navbar-fixed-top  no-border no-margin-bottom main_menu"><!-- start navigattion -->
            <div class="navbar-header ln_full_div">
                ...
                <a class="navbar-brand padding-sm-square ln_full_div" href="/">
                    <img src="/resources/travelopick/images/logo.png" class="img-responsive logo_width center-block" alt="Travelopick">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse xs-no-padding" id="myNavbar">    
                <ul class="nav navbar-nav navbar-right guide_phn_div">
                    <li>
                      <a href="cheap-flights"> <img src="/resources/travelopick/images/flight-icon.png" alt="Flight"> Flights </a> 
                    </li>
                    <li>
                        <a href="hotels"> <img src="/resources/travelopick/images/hotel-icon.png" alt="Hotel"> Hotels </a> 
                    </li>
                    <li class="dropdown hidden-xs hidden-sm" id="searchPad" style="" ng-hide="URL == '/'">
	               ...
	               <li class="dropdown">
	                <a href="javascript: openwindow()"><i class="fa fa-user" aria-hidden="true"></i> Chat Now</a>
	              </li> 
                   ...
                   <li class="toll-free hidden-xs hidden-sm hidden-md visible-lg">
                    
                    <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free">${data.tfnNo}
                    </li>
                    <li class="toll-free hidden-lg">
                
                    <a href="tel:${data.tfnNo}"> <img src="/resources/travelopick/images/phone-icon.png" alt="Toll Free"> ${data.tfnNo}</a>
                    </li>
  ...
  <div class="col-sm-2 hide" style="font-size:22px; font-weight:700; color:#000;"> Menu</div>
      <ul class="nav nav-pills nav-stacked menu-stacked col-sm-2 col-xs-12 no-padding">
        ...
        <div class="tab-content col-sm-9 col-xs-12 no-padding"><!-- start tab content -->
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
            <li> <a href="/deals/specials-mothers-day"> <i class="fa fa-caret-right" aria-hidden="true"></i>  Special Mothers Day </a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
            <li> <a href="/cheap-flights-to-atlanta-atl"> <i class="fa fa-caret-right" aria-hidden="true"></i> Flights to Fort Lauderdale </a></li>
            ...
            <li> <a href="/cheap-flights-to-batonrouge-btr"> <i class="fa fa-caret-right" aria-hidden="true"></i> Flights to Batonrouge </a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
             <li><a href="/cheap-flights-to-jacksonville-jax"><i class="fa fa-caret-rightt"></i>Flights to Jacksonville</a></li>
			 <li><a href="/cheap-flights-to-kansascity-mci"><i class="fa fa-caret-rightt"></i>Flights to Kansas City</a></li>
			 <li><a href="/cheap-flights-to-lexington-lex"><i class="fa fa-caret-rightt"></i>Flights to Lexington</a></li>
             <li><a href="/cheap-flights-to-lihue-lih"><i class="fa fa-caret-rightt"></i>Flights to Lihue</a></li>
	         <li><a href="/cheap-flights-to-losangeles-lax"><i class="fa fa-caret-rightt"></i>Flights to Los Angeles</a></li>
			 <li><a href="/cheap-flights-to-louisville-sdf"><i class="fa fa-caret-rightt"></i>Flights to Louis Ville</a></li>
			 <li><a href="/cheap-flights-to-memphis-mem"><i class="fa fa-caret-rightt"></i>Flights to Memphis</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
             <li><a href="/cheap-flights-to-phoenix-phx"><i class="fa fa-caret-rightt"></i>Flights to Phoenix</a></li>
			 <li><a href="/cheap-flights-to-pittsburgh-pit"><i class="fa fa-caret-rightt"></i>Flights to Pittsburgh</a></li>
			 <li><a href="/cheap-flights-to-reno-rno"><i class="fa fa-caret-rightt"></i>Flights to Reno</a></li>
			 <li><a href="/cheap-flights-to-richmond-ric"><i class="fa fa-caret-rightt"></i>Flights to Richmond</a></li>
			 <li><a href="/cheap-flights-to-rochester-roc"><i class="fa fa-caret-rightt"></i>Flights to Rochester</a></li>
			 <li><a href="/cheap-flights-to-sacramento-sac"><i class="fa fa-caret-rightt"></i>Flights to Sacramento</a></li>
			 <li><a href="/cheap-flights-to-saltlakecity-slc"><i class="fa fa-caret-rightt"></i>Flights to Salt Lake City</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
            <li><a href="/cheap-flights-to-halifax-yhz"><i class="fa-caret-rightt"></i>Flights to Halifax</a></li>
		      <li><a href="/cheap-flights-to-winnipeg-ywg"><i class="fa-caret-rightt"></i>Flights to Winnipeg</a></li>
			  <li><a href="/cheap-flights-to-kingston-ygk"><i class="fa-caret-rightt"></i>Flights to Kingston</a></li>
			  <li><a href="/cheap-flights-to-ottawa-yow"><i class="fa-caret-rightt"></i>Flights to Ottawa</a></li>
			  <li><a href="/cheap-flights-to-peterborough-ypq"><i class="fa-caret-rightt"></i>Flights to Peterborough</a></li>
			  <li><a href="/cheap-flights-to-thunderbay-yqt"><i class="fa-caret-rightt"></i>Flights to Thunder Bay</a></li>
		      <li><a href="/cheap-flights-to-toronto-yto"><i class="fa-caret-rightt"></i>Flights to Toronto</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
             <li><a href="/cheap-flights-to-trenton-ytr"><i class="fa-caret-rightt"></i>Flights to Trenton</a></li>
			 <li><a href="/cheap-flights-to-vancouver-yvr"><i class="fa-caret-rightt"></i>Flights to Vancouver</a></li>
		     <li><a href="/cheap-flights-to-montreal-ymq"><i class="fa-caret-rightt"></i>Flights to Montreal</a></li>
			 <li><a href="/cheap-flights-to-calgary-yyc"><i class="fa-caret-rightt"></i>Flights to Calgary</a></li>
			 <li><a href="/cheap-flights-to-sudbury-ysb"><i class="fa-caret-rightt"></i>Flights to Sudbury</a></li>
		     <li><a href="/cheap-flights-to-yarmouth-yqi"><i class="fa-caret-rightt"></i>Flights to Yarmouth</a></li>
		     <li><a href="/cheap-flights-to-barrie-ylk"><i class="fa-caret-rightt"></i>Flights to Barrie</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
           <li><a href="/cheap-flights-to-edmonton-yea"><i class="fa-caret-rightt"></i>Flights to Edmonton</a></li>
			  <li><a href="/cheap-flights-to-regina-yqr"><i class="fa-caret-rightt"></i>Flights to Regina</a></li>
			  <li><a href="/cheap-flights-to-victoria-yyj"><i class="fa-caret-rightt"></i>Flights to Victoria</a></li>
			  <li><a href="/cheap-flights-to-quebec-yqb"><i class="fa-caret-rightt"></i>Flights to Quebec</a></li>
			  <li><a href="/cheap-flights-to-penticton-yyf"><i class="fa-caret-rightt"></i>Flights to Penticton</a></li>
		      <li><a href="/cheap-flights-to-moosejaw-ymj"><i class="fa-caret-rightt"></i>Flights to Moosejaw</a></li>
			  <li><a href="/cheap-flights-to-masset-zmt"><i class="fa-caret-rightt"></i>Flights to Masset</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
            <li><a href="/cheap-flights-to-bangkok-bkk"><i class="fa-caret-rightt"></i>Flights to Bangkok</a></li>
	         <li><a href="/cheap-flights-to-barcelona-bcn"><i class="fa-caret-rightt"></i>Flights to Barcelona</a></li>
		     <li><a href="/cheap-flights-to-cancun-cun"><i class="fa-caret-rightt"></i>Flights to Cancun</a></li>
		     <li><a href="/cheap-flights-to-abudhabi-auh"><i class="fa-caret-rightt"></i>Flights to Abudhabi</a></li>
			 <li><a href="/cheap-flights-to-amsterdam-ams"><i class="fa-caret-rightt"></i>Flights to Amsterdam</a></li>
			 <li><a href="/cheap-flights-to-toronto-yto"><i class="fa-caret-rightt"></i>Flights to Toronto</a></li>
		     <li><a href="/cheap-flights-to-guadalajara-gdl "><i class="fa-caret-rightt"></i>Flights to Guadalajara</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
            <li><a href="/cheap-flights-to-mexico-mex"><i class="fa-caret-rightt"></i>Flights to Mexico</a></li>
			 <li><a href="/cheap-flights-to-moscow-mow"><i class="fa-caret-rightt"></i>Flights to Moscow</a></li>
		      <li><a href="/cheap-flights-to-nassau-nas"><i class="fa-caret-rightt"></i>Flights to Nassau</a></li>
			  <li><a href="/cheap-flights-to-puertovallarta-pvr"><i class="fa-caret-rightt"></i>Flights to Puertovallarta</a></li>
			  	<li><a href="/cheap-flights-to-lima-lim"><i class="fa-caret-rightt"></i>Flights to Lima</a></li>
			  <li><a href="/cheap-flights-to-dublin-dub"><i class="fa-caret-rightt"></i>Flights to Dublin</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
           <li><a href="/cheap-flights-to-dubai-dxb"><i class="fa-caret-rightt"></i>Flights to Dubai</a></li>
			  <li><a href="/cheap-flights-to-london-lon"><i class="fa-caret-rightt"></i>Flights to London</a></li>
			  <li><a href="/cheap-flights-to-paris-par"><i class="fa-caret-rightt"></i>Flights to Paris</a></li>
			  <li><a href="/cheap-flights-to-rome-rom"><i class="fa-caret-rightt"></i>Flights to Rome</a></li>
			  <li><a href="/cheap-flights-to-frankfurt-fra"><i class="fa-caret-rightt"></i>Flights to Frankfurt</a></li>
			  <li><a href="/cheap-flights-to-manila-mnl"><i class="fa-caret-rightt"></i>Flights to Manila</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
            <li><a href="/cheap-airline/aer-lingus-ei-and-flight-deals"><i class="fa-caret-rightt"></i>Aer Lingus Flights </a></li>
             <li><a href="/cheap-airline/air-canada-ac-and-flight-deals"><i class="fa-caret-rightt"></i>Air Canada Flights</a></li>
			  <li><a href="/cheap-airline/american-airlines-aa-and-flight-deals"><i class="fa-caret-rightt"></i>American Airlines Flights</a></li>
			   <li><a href="/cheap-airline/british-airways-ba-and-flight-deals"><i class="fa-caret-rightt"></i>British Airways Flights</a></li>
			   
				<li><a href="/cheap-airline/lufthansa-airlines-lh-and-flight-deals"><i class="fa-caret-rightt"></i>Lufthansa Airlines Flights</a></li>
			    <li><a href="/cheap-airline/philippine-airlines-pr-and-flight-deals"><i class="fa-caret-rightt"></i>Philippine Airlines Flights</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
          <li><a href="/cheap-airline/qatar-airways-qr-and-flight-deals"><i class="fa-caret-rightt"></i>Qatar Airways Flights </a></li>
                   <li><a href="/cheap-airline/westjet-airlines-ws-and-flight-deals"><i class="fa-caret-rightt"></i>Westjet Airlines Flights</a></li>
			       <li><a href="/cheap-airline/asiana-airlines-oz-and-flight-deals"><i class="fa-caret-rightt"></i>Asiana Airlines Flights</a></li>
			       <li><a href="/cheap-airline/allnippon-airways-nh-and-flight-deals"><i class="fa-caret-rightt"></i>All Nippon Airways Flights</a></li>
			    <li><a href="/cheap-airline/eva-air-br-and-flight-deals"><i class="fa-caret-rightt"></i>Eva Air Flights</a></li>
				<li><a href="/cheap-airline/cathaypacific-airways-cx-and-flight-deals"><i class="fa-caret-rightt"></i>Cathay Pacific Airways Flights</a></li>
			    <li><a href="/cheap-airline/emirates-airlines-ek-and-flight-deals"><i class="fa-caret-rightt"></i>Emirates Airlines Flights</a></li>
            ...
            <div class="col-sm-4 menu_sub">
            <ul>
         <li><a href="/cheap-airline/etihad-airways-ey-and-flight-deals"><i class="fa-caret-rightt"></i>Etihad Airways Flights </a></li>
             <li><a href="/cheap-airline/garuda-indonesia-ga-and-flight-deals"><i class="fa-caret-rightt"></i>Garuda Indonesia Flights</a></li>
			  <li><a href="/cheap-airline/qantas-airways-qf-and-flight-deals"><i class="fa-caret-rightt"></i>Qantas Airways Flights</a></li>
			   <li><a href="/cheap-airline/singapore-airlines-sq-and-flight-deals"><i class="fa-caret-rightt"></i>Singapore Airlines Flights</a></li>
			    <li><a href="/cheap-airline/turkish-airlines-tk-and-flight-deals"><i class="fa-caret-rightt"></i>Turkish Airlines Flights</a></li>
				<li><a href="/cheap-airline/southwest-airlines-wn-and-flight-deals"><i class="fa-caret-rightt"></i>Southwest Airlines Flights</a></li>
			   <li><a href="/cheap-airline/air-mauritius-mk-and-flight-deals"><i class="fa-caret-rightt"></i>Air Mauritius Flights</a></li>
        ...
        <div class="menu_read"> <a href="/site-map"> READ MORE</a></div>
      ...
      <div class="modal-dialog popu_width row">
        ...
        <div class="modal-content no-border-radius no-padding col-sm-7 no-border no-box-shadow popup_heght"><!-- start of modal_popup -->
            <div class="modal-header no-border">
                ...
                <h4 class="modal-title hide"><span class="border-bottom-orange">Log</span>in to ${data.siteName}</h4>
            </div>
